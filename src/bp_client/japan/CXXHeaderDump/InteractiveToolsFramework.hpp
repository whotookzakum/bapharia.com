...
class UBrushStampIndicator : public UInteractiveGizmo
{
    ...
    char padding_0[0x2];                                                              // 0x005A (size: 0x2)
...
{
    FVector Direction;                                                                // 0x0488 (size: 0xC)
    float Gap;                                                                        // 0x0494 (size: 0x4)
    float Length;                                                                     // 0x0498 (size: 0x4)
    float Thickness;                                                                  // 0x049C (size: 0x4)
...
{
    FLinearColor Color;                                                               // 0x0468 (size: 0x10)
    float HoverSizeMultiplier;                                                        // 0x0478 (size: 0x4)
    float PixelHitDistanceThreshold;                                                  // 0x047C (size: 0x4)
...
{
    FVector Origin;                                                                   // 0x0488 (size: 0xC)
    char padding_0[0xC];                                                              // 0x0494 (size: 0xC)
    FQuat Rotation;                                                                   // 0x04A0 (size: 0x10)
    FVector Dimensions;                                                               // 0x04B0 (size: 0xC)
    float LineThickness;                                                              // 0x04BC (size: 0x4)
    bool bRemoveHiddenLines;                                                          // 0x04C0 (size: 0x1)
    bool bEnableAxisFlip;                                                             // 0x04C1 (size: 0x1)

}; // Size: 0x4D0

class UGizmoCircleComponent : public UGizmoBaseComponent
{
    FVector Normal;                                                                   // 0x0488 (size: 0xC)
    float Radius;                                                                     // 0x0494 (size: 0x4)
    float Thickness;                                                                  // 0x0498 (size: 0x4)
    int32 NumSides;                                                                   // 0x049C (size: 0x4)
    bool bViewAligned;                                                                // 0x04A0 (size: 0x1)
    bool bOnlyAllowFrontFacingHits;                                                   // 0x04A1 (size: 0x1)
...
{
    FVector Normal;                                                                   // 0x0488 (size: 0xC)
    float HandleSize;                                                                 // 0x0494 (size: 0x4)
    float Thickness;                                                                  // 0x0498 (size: 0x4)
    FVector Direction;                                                                // 0x049C (size: 0xC)
    float Length;                                                                     // 0x04A8 (size: 0x4)
    bool bImageScale;                                                                 // 0x04AC (size: 0x1)
...
{
    FVector DirectionX;                                                               // 0x0488 (size: 0xC)
    FVector DirectionY;                                                               // 0x0494 (size: 0xC)
    float offsetX;                                                                    // 0x04A0 (size: 0x4)
    float offsetY;                                                                    // 0x04A4 (size: 0x4)
    float LengthX;                                                                    // 0x04A8 (size: 0x4)
    float LengthY;                                                                    // 0x04AC (size: 0x4)
    float Thickness;                                                                  // 0x04B0 (size: 0x4)
    uint8 SegmentFlags;                                                               // 0x04B4 (size: 0x1)
...
class UTransformGizmo : public UInteractiveGizmo
{
    ...
    char padding_3[0x90];                                                             // 0x0070 (size: 0x90)
    ...
    char padding_4[0x10];                                                             // 0x0130 (size: 0x10)
