...
class UFoliageType : public UObject
{
    ...
    char padding_13[0x7];                                                             // 0x0159 (size: 0x7)
    FBodyInstance BodyInstance;                                                       // 0x0160 (size: 0x158)
    uint8 bUseDefaultCollision;                                                       // 0x02B8 (size: 0x1)
    TEnumAsByte<EHasCustomNavigableGeometry::Type> CustomNavigableGeometry;           // 0x02B9 (size: 0x1)
    FLightingChannels LightingChannels;                                               // 0x02BA (size: 0x1)
    char padding_14[0x1];                                                             // 0x02BB (size: 0x1)
    uint8 bRenderCustomDepth;                                                         // 0x02BC (size: 0x1)
    char padding_15[0x3];                                                             // 0x02BD (size: 0x3)
    ERendererStencilMask CustomDepthStencilWriteMask;                                 // 0x02C0 (size: 0x1)
    char padding_16[0x3];                                                             // 0x02C1 (size: 0x3)
    ...
    char padding_17[0x2];                                                             // 0x02F2 (size: 0x2)
    ...
    char padding_18[0x1];                                                             // 0x0397 (size: 0x1)
...
{
    char padding_0[0x500];                                                            // 0x0000 (size: 0x0)
}; // Size: 0x500
