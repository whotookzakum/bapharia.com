...
{
    class UFieldSystem* FieldSystem;                                                  // 0x0468 (size: 0x8)
    bool bIsWorldField;                                                               // 0x0470 (size: 0x1)
    bool bIsChaosField;                                                               // 0x0471 (size: 0x1)
    char padding_0[0x6];                                                              // 0x0472 (size: 0x6)
    TArray<TSoftObjectPtr<AChaosSolverActor>> SupportedSolvers;                       // 0x0478 (size: 0x10)
    FFieldObjectCommands ConstructionCommands;                                        // 0x0488 (size: 0x30)
    FFieldObjectCommands BufferCommands;                                              // 0x04B8 (size: 0x30)
...
class UPlaneFalloff : public UFieldNodeFloat
{
    ...
    FVector Position;                                                                 // 0x00CC (size: 0xC)
    FVector Normal;                                                                   // 0x00D8 (size: 0xC)
    TEnumAsByte<EFieldFalloffType> Falloff;                                           // 0x00E4 (size: 0x1)
...
class URadialIntMask : public UFieldNodeInt
{
    ...
    FVector Position;                                                                 // 0x00BC (size: 0xC)
...
{
    float Magnitude;                                                                  // 0x00B8 (size: 0x4)
    FVector Direction;                                                                // 0x00BC (size: 0xC)
