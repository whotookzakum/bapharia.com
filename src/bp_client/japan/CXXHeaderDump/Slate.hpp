...
{
    FEditableTextBoxStyle EditableTextBoxStyle;                                       // 0x0030 (size: 0x838)

}; // Size: 0x868

class UEditableTextWidgetStyle : public USlateWidgetStyleContainerBase
{
    FEditableTextStyle EditableTextStyle;                                             // 0x0030 (size: 0x250)
...
{
    FScrollBarStyle ScrollBarStyle;                                                   // 0x0030 (size: 0x4E0)
...
{
    FTextBlockStyle TextBlockStyle;                                                   // 0x0030 (size: 0x2A0)
