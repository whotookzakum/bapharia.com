...
struct FXRHMDData
{
    ...
    char padding_2[0x4];                                                              // 0x002C (size: 0x4)
...
struct FXRMotionControllerData
{
    ...
    char padding_3[0x4];                                                              // 0x004C (size: 0x4)
...
{
    int32 PlayerIndex;                                                                // 0x0468 (size: 0x4)
    EControllerHand Hand;                                                             // 0x046C (size: 0x1)
    char padding_0[0x3];                                                              // 0x046D (size: 0x3)
    FName MotionSource;                                                               // 0x0470 (size: 0x8)
    uint8 bDisableLowLatencyUpdate;                                                   // 0x0478 (size: 0x1)
    char padding_1[0x3];                                                              // 0x0479 (size: 0x3)
    ETrackingStatus CurrentTrackingStatus;                                            // 0x047C (size: 0x1)
    bool bDisplayDeviceModel;                                                         // 0x047D (size: 0x1)
    char padding_2[0x2];                                                              // 0x047E (size: 0x2)
    FName DisplayModelSource;                                                         // 0x0480 (size: 0x8)
    class UStaticMesh* CustomDisplayMesh;                                             // 0x0488 (size: 0x8)
    TArray<class UMaterialInterface*> DisplayMeshMaterialOverrides;                   // 0x0490 (size: 0x10)
    char padding_3[0x60];                                                             // 0x04A0 (size: 0x60)
    class UPrimitiveComponent* DisplayComponent;                                      // 0x0500 (size: 0x8)
...
{
    FVRNotificationsComponentHMDTrackingInitializingAndNeedsHMDToBeTrackedDelegate HMDTrackingInitializingAndNeedsHMDToBeTrackedDelegate; // 0x00B8 (size: 0x10)
    void VRNotificationsDelegate();
    FVRNotificationsComponentHMDTrackingInitializedDelegate HMDTrackingInitializedDelegate; // 0x00C8 (size: 0x10)
    void VRNotificationsDelegate();
    FVRNotificationsComponentHMDRecenteredDelegate HMDRecenteredDelegate;             // 0x00D8 (size: 0x10)
    void VRNotificationsDelegate();
    FVRNotificationsComponentHMDLostDelegate HMDLostDelegate;                         // 0x00E8 (size: 0x10)
    void VRNotificationsDelegate();
    FVRNotificationsComponentHMDReconnectedDelegate HMDReconnectedDelegate;           // 0x00F8 (size: 0x10)
    void VRNotificationsDelegate();
    FVRNotificationsComponentHMDConnectCanceledDelegate HMDConnectCanceledDelegate;   // 0x0108 (size: 0x10)
    void VRNotificationsDelegate();
    FVRNotificationsComponentHMDPutOnHeadDelegate HMDPutOnHeadDelegate;               // 0x0118 (size: 0x10)
    void VRNotificationsDelegate();
    FVRNotificationsComponentHMDRemovedFromHeadDelegate HMDRemovedFromHeadDelegate;   // 0x0128 (size: 0x10)
    void VRNotificationsDelegate();
    FVRNotificationsComponentVRControllerRecenteredDelegate VRControllerRecenteredDelegate; // 0x0138 (size: 0x10)
    void VRNotificationsDelegate();
