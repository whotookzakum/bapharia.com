...
{
    char padding_0[0xE];                                                              // 0x0000 (size: 0x0)
}; // Size: 0xE
...
struct FRigVMRegister
{
    ...
    char padding_2[0x2];                                                              // 0x0012 (size: 0x2)
...
class URigVM : public UObject
{
    ...
    char padding_1[0x8];                                                              // 0x0170 (size: 0x8)
    FRigVMByteCode ByteCodeStorage;                                                   // 0x0178 (size: 0x30)
    char padding_2[0x8];                                                              // 0x01A8 (size: 0x8)
