...
struct FClothLODDataCommon
{
    ...
    char padding_0[0x3];                                                              // 0x0149 (size: 0x3)
...
struct FClothPhysicalMeshData
{
    ...
    char padding_0[0x10];                                                             // 0x00B8 (size: 0x10)
    TArray<float> MaxDistances;                                                       // 0x00C8 (size: 0x10)
    TArray<float> BackstopDistances;                                                  // 0x00D8 (size: 0x10)
    TArray<float> BackstopRadiuses;                                                   // 0x00E8 (size: 0x10)
    TArray<float> AnimDriveMultipliers;                                               // 0x00F8 (size: 0x10)
...
{
    class UClothConfigCommon* ClothConfig;                                            // 0x0030 (size: 0x8)
...
class UClothingAssetCommon : public UClothingAssetBase
{
    ...
    class UClothConfigAssetBase* OverrideClothConfigAsset;                            // 0x0050 (size: 0x8)
    TMap<class FName, class UClothConfigBase*> ClothConfigs;                          // 0x0058 (size: 0x50)
    TArray<FClothLODDataCommon> LODData;                                              // 0x00A8 (size: 0x10)
    TArray<int32> LodMap;                                                             // 0x00B8 (size: 0x10)
    TArray<FName> UsedBoneNames;                                                      // 0x00C8 (size: 0x10)
    TArray<int32> UsedBoneIndices;                                                    // 0x00D8 (size: 0x10)
    int32 ReferenceBoneIndex;                                                         // 0x00E8 (size: 0x4)
    char padding_0[0x4];                                                              // 0x00EC (size: 0x4)
    class UClothingAssetCustomData* CustomData;                                       // 0x00F0 (size: 0x8)
