...
{
    char padding_0[0x580];                                                            // 0x0000 (size: 0x0)
...
class UARComponent : public USceneComponent
{
    ...
    char padding_0[0x30];                                                             // 0x0218 (size: 0x30)
...
class UAREnvironmentCaptureProbeTexture : public UTextureCube
{
    ...
    char padding_0[0x3];                                                              // 0x01D1 (size: 0x3)
...
class UARFaceComponent : public UARComponent
{
    ...
    char padding_0[0x5];                                                              // 0x028B (size: 0x5)
...
class UARFaceGeometry : public UARTrackedGeometry
{
    ...
    char padding_0[0x3];                                                              // 0x0105 (size: 0x3)
    TMap<EARFaceBlendShape, float> BlendShapes;                                       // 0x0108 (size: 0x50)
    char padding_1[0x38];                                                             // 0x0158 (size: 0x38)
...
class UARSessionConfig : public UDataAsset
{
    ...
    char padding_2[0x1];                                                              // 0x008F (size: 0x1)
    ...
    char padding_4[0x6];                                                              // 0x00AA (size: 0x6)
...
class UARTexture : public UTexture
{
    ...
    char padding_0[0x3];                                                              // 0x0179 (size: 0x3)
...
{
    char padding_0[0x1A0];                                                            // 0x0000 (size: 0x0)
}; // Size: 0x1A0
...
{
    FARTrackableNotifyComponentOnAddTrackedGeometry OnAddTrackedGeometry;             // 0x00B8 (size: 0x10)
    void TrackableDelegate(class UARTrackedGeometry* TrackedGeometry);
    FARTrackableNotifyComponentOnUpdateTrackedGeometry OnUpdateTrackedGeometry;       // 0x00C8 (size: 0x10)
    void TrackableDelegate(class UARTrackedGeometry* TrackedGeometry);
    FARTrackableNotifyComponentOnRemoveTrackedGeometry OnRemoveTrackedGeometry;       // 0x00D8 (size: 0x10)
    void TrackableDelegate(class UARTrackedGeometry* TrackedGeometry);
    FARTrackableNotifyComponentOnAddTrackedPlane OnAddTrackedPlane;                   // 0x00E8 (size: 0x10)
    void TrackablePlaneDelegate(class UARPlaneGeometry* TrackedPlane);
    FARTrackableNotifyComponentOnUpdateTrackedPlane OnUpdateTrackedPlane;             // 0x00F8 (size: 0x10)
    void TrackablePlaneDelegate(class UARPlaneGeometry* TrackedPlane);
    FARTrackableNotifyComponentOnRemoveTrackedPlane OnRemoveTrackedPlane;             // 0x0108 (size: 0x10)
    void TrackablePlaneDelegate(class UARPlaneGeometry* TrackedPlane);
    FARTrackableNotifyComponentOnAddTrackedPoint OnAddTrackedPoint;                   // 0x0118 (size: 0x10)
    void TrackablePointDelegate(class UARTrackedPoint* TrackedPoint);
    FARTrackableNotifyComponentOnUpdateTrackedPoint OnUpdateTrackedPoint;             // 0x0128 (size: 0x10)
    void TrackablePointDelegate(class UARTrackedPoint* TrackedPoint);
    FARTrackableNotifyComponentOnRemoveTrackedPoint OnRemoveTrackedPoint;             // 0x0138 (size: 0x10)
    void TrackablePointDelegate(class UARTrackedPoint* TrackedPoint);
    FARTrackableNotifyComponentOnAddTrackedImage OnAddTrackedImage;                   // 0x0148 (size: 0x10)
    void TrackableImageDelegate(class UARTrackedImage* TrackedImage);
    FARTrackableNotifyComponentOnUpdateTrackedImage OnUpdateTrackedImage;             // 0x0158 (size: 0x10)
    void TrackableImageDelegate(class UARTrackedImage* TrackedImage);
    FARTrackableNotifyComponentOnRemoveTrackedImage OnRemoveTrackedImage;             // 0x0168 (size: 0x10)
    void TrackableImageDelegate(class UARTrackedImage* TrackedImage);
    FARTrackableNotifyComponentOnAddTrackedFace OnAddTrackedFace;                     // 0x0178 (size: 0x10)
    void TrackableFaceDelegate(class UARFaceGeometry* TrackedFace);
    FARTrackableNotifyComponentOnUpdateTrackedFace OnUpdateTrackedFace;               // 0x0188 (size: 0x10)
    void TrackableFaceDelegate(class UARFaceGeometry* TrackedFace);
    FARTrackableNotifyComponentOnRemoveTrackedFace OnRemoveTrackedFace;               // 0x0198 (size: 0x10)
    void TrackableFaceDelegate(class UARFaceGeometry* TrackedFace);
    FARTrackableNotifyComponentOnAddTrackedEnvProbe OnAddTrackedEnvProbe;             // 0x01A8 (size: 0x10)
    void TrackableEnvProbeDelegate(class UAREnvironmentCaptureProbe* TrackedEnvProbe);
    FARTrackableNotifyComponentOnUpdateTrackedEnvProbe OnUpdateTrackedEnvProbe;       // 0x01B8 (size: 0x10)
    void TrackableEnvProbeDelegate(class UAREnvironmentCaptureProbe* TrackedEnvProbe);
    FARTrackableNotifyComponentOnRemoveTrackedEnvProbe OnRemoveTrackedEnvProbe;       // 0x01C8 (size: 0x10)
    void TrackableEnvProbeDelegate(class UAREnvironmentCaptureProbe* TrackedEnvProbe);
    FARTrackableNotifyComponentOnAddTrackedObject OnAddTrackedObject;                 // 0x01D8 (size: 0x10)
    void TrackableObjectDelegate(class UARTrackedObject* TrackedObject);
    FARTrackableNotifyComponentOnUpdateTrackedObject OnUpdateTrackedObject;           // 0x01E8 (size: 0x10)
    void TrackableObjectDelegate(class UARTrackedObject* TrackedObject);
    FARTrackableNotifyComponentOnRemoveTrackedObject OnRemoveTrackedObject;           // 0x01F8 (size: 0x10)
    void TrackableObjectDelegate(class UARTrackedObject* TrackedObject);
...
class UARTrackedGeometry : public UObject
{
    ...
    char padding_2[0x16];                                                             // 0x00BA (size: 0x16)
