...
struct FNiagaraDebugHUDSettingsData
{
    ...
    char padding_3[0x3];                                                              // 0x0069 (size: 0x3)
    ...
    char padding_4[0x1];                                                              // 0x0077 (size: 0x1)
    ...
    char padding_5[0x6];                                                              // 0x009A (size: 0x6)
    ...
    char padding_6[0x2];                                                              // 0x00C2 (size: 0x2)
...
struct FNiagaraVMExecutableData
{
    ...
    char padding_1[0x10];                                                             // 0x0080 (size: 0x10)
...
class UNiagaraBakerSettings : public UObject
{
    ...
    char padding_1[0x3];                                                              // 0x0109 (size: 0x3)
...
{
    class UNiagaraSystem* Asset;                                                      // 0x0468 (size: 0x8)
    ENiagaraTickBehavior TickBehavior;                                                // 0x0470 (size: 0x1)
    char padding_0[0x3];                                                              // 0x0471 (size: 0x3)
    int32 RandomSeedOffset;                                                           // 0x0474 (size: 0x4)
    FNiagaraUserRedirectionParameterStore OverrideParameters;                         // 0x0478 (size: 0xC8)
    uint8 bForceSolo;                                                                 // 0x0540 (size: 0x1)
    uint8 bEnableGpuComputeDebug;                                                     // 0x0540 (size: 0x1)
    char padding_1[0x2F];                                                             // 0x0541 (size: 0x2F)
    uint8 bAutoDestroy;                                                               // 0x0570 (size: 0x1)
    uint8 bRenderingEnabled;                                                          // 0x0570 (size: 0x1)
    uint8 bAutoManageAttachment;                                                      // 0x0570 (size: 0x1)
    uint8 bAutoAttachWeldSimulatedBodies;                                             // 0x0570 (size: 0x1)
    char padding_2[0x3];                                                              // 0x0571 (size: 0x3)
    float MaxTimeBeforeForceUpdateTransform;                                          // 0x0574 (size: 0x4)
    TArray<FNiagaraMaterialOverride> EmitterMaterials;                                // 0x0578 (size: 0x10)
    char padding_3[0x8];                                                              // 0x0588 (size: 0x8)
    FNiagaraComponentOnSystemFinished OnSystemFinished;                               // 0x0590 (size: 0x10)
    void OnNiagaraSystemFinished(class UNiagaraComponent* PSystem);
    TWeakObjectPtr<class USceneComponent> AutoAttachParent;                           // 0x05A0 (size: 0x8)
    FName AutoAttachSocketName;                                                       // 0x05A8 (size: 0x8)
    EAttachmentRule AutoAttachLocationRule;                                           // 0x05B0 (size: 0x1)
    EAttachmentRule AutoAttachRotationRule;                                           // 0x05B1 (size: 0x1)
    EAttachmentRule AutoAttachScaleRule;                                              // 0x05B2 (size: 0x1)
...
class UNiagaraComponentRendererProperties : public UNiagaraRendererProperties
{
    ...
    char padding_1[0x2];                                                              // 0x013A (size: 0x2)
...
class UNiagaraDataInterfaceGrid2DCollection : public UNiagaraDataInterfaceGrid2D
{
    ...
    char padding_0[0x56];                                                             // 0x011A (size: 0x56)
...
class UNiagaraDataInterfaceRenderTarget2DArray : public UNiagaraDataInterfaceRWBase
{
    ...
    char padding_0[0x2];                                                              // 0x00E6 (size: 0x2)
    FNiagaraUserParameterBinding RenderTargetUserParameter;                           // 0x00E8 (size: 0x20)
...
class UNiagaraDataInterfaceRenderTargetCube : public UNiagaraDataInterfaceRWBase
{
    ...
    char padding_0[0x2];                                                              // 0x00DE (size: 0x2)
    FNiagaraUserParameterBinding RenderTargetUserParameter;                           // 0x00E0 (size: 0x20)
...
class UNiagaraEmitter : public UObject
{
    ...
    char padding_3[0x4];                                                              // 0x00C4 (size: 0x4)
    ...
    char padding_4[0x3];                                                              // 0x0109 (size: 0x3)
    ...
    char padding_5[0x7];                                                              // 0x0169 (size: 0x7)
...
class UNiagaraMeshRendererProperties : public UNiagaraRendererProperties
{
    ...
    char padding_6[0x68];                                                             // 0x0818 (size: 0x68)
...
class UNiagaraRibbonRendererProperties : public UNiagaraRendererProperties
{
    ...
    char padding_2[0x4];                                                              // 0x00FC (size: 0x4)
...
class UNiagaraScript : public UNiagaraScriptBase
{
    ...
    char padding_2[0x10];                                                             // 0x01B8 (size: 0x10)
...
class UNiagaraSettings : public UDeveloperSettings
{
    ...
    char padding_0[0x2];                                                              // 0x00B2 (size: 0x2)
    ...
    char padding_1[0x5];                                                              // 0x00BB (size: 0x5)
...
class UNiagaraSpriteRendererProperties : public UNiagaraRendererProperties
{
    ...
    char padding_3[0x3];                                                              // 0x00C1 (size: 0x3)
...
{
    bool bDumpDebugSystemInfo;                                                        // 0x0038 (size: 0x1)
    bool bDumpDebugEmitterInfo;                                                       // 0x0039 (size: 0x1)
    char padding_0[0x1];                                                              // 0x003A (size: 0x1)
    bool bRequireCurrentFrameData;                                                    // 0x003B (size: 0x1)
    uint8 bFixedBounds;                                                               // 0x003C (size: 0x1)
    char padding_1[0x3];                                                              // 0x003D (size: 0x3)
    class UNiagaraEffectType* EffectType;                                             // 0x0040 (size: 0x8)
    bool bOverrideScalabilitySettings;                                                // 0x0048 (size: 0x1)
    char padding_2[0x7];                                                              // 0x0049 (size: 0x7)
    TArray<FNiagaraSystemScalabilityOverride> ScalabilityOverrides;                   // 0x0050 (size: 0x10)
    FNiagaraSystemScalabilityOverrides SystemScalabilityOverrides;                    // 0x0060 (size: 0x10)
    TArray<FNiagaraEmitterHandle> EmitterHandles;                                     // 0x0070 (size: 0x10)
    TArray<class UNiagaraParameterCollectionInstance*> ParameterCollectionOverrides;  // 0x0080 (size: 0x10)
    class UNiagaraScript* SystemSpawnScript;                                          // 0x0090 (size: 0x8)
    class UNiagaraScript* SystemUpdateScript;                                         // 0x0098 (size: 0x8)
    char padding_3[0x10];                                                             // 0x00A0 (size: 0x10)
    FNiagaraSystemCompiledData SystemCompiledData;                                    // 0x00B0 (size: 0x218)
    FNiagaraUserRedirectionParameterStore ExposedParameters;                          // 0x02C8 (size: 0xC8)
    FBox FixedBounds;                                                                 // 0x0390 (size: 0x1C)
    bool bAutoDeactivate;                                                             // 0x03AC (size: 0x1)
    char padding_4[0x3];                                                              // 0x03AD (size: 0x3)
    float WarmupTime;                                                                 // 0x03B0 (size: 0x4)
    int32 WarmupTickCount;                                                            // 0x03B4 (size: 0x4)
    float WarmupTickDelta;                                                            // 0x03B8 (size: 0x4)
    bool bHasSystemScriptDIsWithPerInstanceData;                                      // 0x03BC (size: 0x1)
    bool bNeedsGPUContextInitForDataInterfaces;                                       // 0x03BD (size: 0x1)
    char padding_5[0x2];                                                              // 0x03BE (size: 0x2)
    TArray<FName> UserDINamesReadInSystemScripts;                                     // 0x03C0 (size: 0x10)
    char padding_6[0xD0];                                                             // 0x03D0 (size: 0xD0)
    TArray<class UAssetUserData*> AssetUserData;                                      // 0x04A0 (size: 0x10)
