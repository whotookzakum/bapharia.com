...
struct FAnimNode_ControlRig : public FAnimNode_ControlRigBase
{
    ...
    char padding_0[0x2];                                                              // 0x0186 (size: 0x2)
    ...
    char padding_1[0xB0];                                                             // 0x02B0 (size: 0xB0)
...
{
    char padding_0[0x810];                                                            // 0x0000 (size: 0x0)
}; // Size: 0x810
...
struct FControlRigDrawInstruction
{
    ...
    char padding_1[0xC];                                                              // 0x0034 (size: 0xC)
...
{
    char padding_0[0xCC0];                                                            // 0x0000 (size: 0x0)
}; // Size: 0xCC0
...
struct FRigBone : public FRigElement
{
    ...
    char padding_0[0xC];                                                              // 0x0024 (size: 0xC)
...
struct FRigControl : public FRigElement
{
    ...
    char padding_2[0x9];                                                              // 0x0177 (size: 0x9)
    ...
    char padding_3[0x2];                                                              // 0x0282 (size: 0x2)
    FName GizmoName;                                                                  // 0x0284 (size: 0x8)
    char padding_4[0x4];                                                              // 0x028C (size: 0x4)
    ...
    char padding_5[0x7];                                                              // 0x02E1 (size: 0x7)
...
struct FRigControlValue
{
    ...
    char padding_0[0xC];                                                              // 0x0044 (size: 0xC)
...
struct FRigSpace : public FRigElement
{
    ...
    char padding_1[0x8];                                                              // 0x0028 (size: 0x8)
    FTransform InitialTransform;                                                      // 0x0030 (size: 0x30)
...
struct FRigUnit_AccumulateQuatLerp : public FRigUnit_SimBase
{
    ...
    char padding_0[0xB];                                                              // 0x0035 (size: 0xB)
...
struct FRigUnit_AccumulateQuatMul : public FRigUnit_SimBase
{
    ...
    char padding_0[0xE];                                                              // 0x0032 (size: 0xE)
    FQuat Result;                                                                     // 0x0040 (size: 0x10)
    FQuat AccumulatedValue;                                                           // 0x0050 (size: 0x10)
...
struct FRigUnit_AccumulateTransformLerp : public FRigUnit_SimBase
{
    ...
    char padding_0[0xB];                                                              // 0x0075 (size: 0xB)
...
struct FRigUnit_AccumulateTransformMul : public FRigUnit_SimBase
{
    ...
    char padding_0[0xE];                                                              // 0x0072 (size: 0xE)
    FTransform Result;                                                                // 0x0080 (size: 0x30)
    FTransform AccumulatedValue;                                                      // 0x00B0 (size: 0x30)
...
struct FRigUnit_AddBoneTransform : public FRigUnitMutable
{
    ...
    char padding_0[0x2];                                                              // 0x00A6 (size: 0x2)
...
struct FRigUnit_AimBone_DebugSettings
{
    ...
    char padding_1[0x8];                                                              // 0x0008 (size: 0x8)
...
struct FRigUnit_AimConstraint : public FRigUnitMutable
{
    ...
    char padding_0[0x2];                                                              // 0x0072 (size: 0x2)
...
struct FRigUnit_ApplyFK : public FRigUnitMutable
{
    ...
    char padding_0[0x5];                                                              // 0x00AB (size: 0x5)
...
struct FRigUnit_BoneHarmonics : public FRigUnit_HighlevelBaseMutable
{
    ...
    char padding_1[0x6];                                                              // 0x00C2 (size: 0x6)
...
struct FRigUnit_CCDIK : public FRigUnit_HighlevelBaseMutable
{
    ...
    char padding_0[0x8];                                                              // 0x0078 (size: 0x8)
...
struct FRigUnit_ChainHarmonics : public FRigUnit_HighlevelBaseMutable
{
    ...
    char padding_1[0x3];                                                              // 0x01AD (size: 0x3)
...
struct FRigUnit_ChainHarmonicsPerItem : public FRigUnit_HighlevelBaseMutable
{
    ...
    FRigUnit_ChainHarmonics_Pendulum Pendulum;                                        // 0x0170 (size: 0x3C)
    bool bDrawDebug;                                                                  // 0x01AC (size: 0x1)
    char padding_0[0x3];                                                              // 0x01AD (size: 0x3)
    FTransform DrawWorldOffset;                                                       // 0x01B0 (size: 0x30)
    FRigUnit_ChainHarmonics_WorkData WorkData;                                        // 0x01E0 (size: 0x90)
...
struct FRigUnit_CollectionChildren : public FRigUnit_CollectionBase
{
    ...
    char padding_0[0x1];                                                              // 0x0017 (size: 0x1)
...
struct FRigUnit_DebugLineStrip : public FRigUnit_DebugBaseMutable
{
    ...
    char padding_0[0xC];                                                              // 0x0094 (size: 0xC)
    FTransform WorldOffset;                                                           // 0x00A0 (size: 0x30)
    bool bEnabled;                                                                    // 0x00D0 (size: 0x1)
...
struct FRigUnit_DebugLineStripItemSpace : public FRigUnit_DebugBaseMutable
{
    ...
    char padding_0[0x8];                                                              // 0x0098 (size: 0x8)
    FTransform WorldOffset;                                                           // 0x00A0 (size: 0x30)
    bool bEnabled;                                                                    // 0x00D0 (size: 0x1)
...
struct FRigUnit_DebugPoint : public FRigUnit_DebugBase
{
    ...
    char padding_1[0x8];                                                              // 0x0038 (size: 0x8)
...
struct FRigUnit_DebugPointMutable : public FRigUnit_DebugBaseMutable
{
    ...
    char padding_1[0x8];                                                              // 0x0098 (size: 0x8)
    FTransform WorldOffset;                                                           // 0x00A0 (size: 0x30)
    bool bEnabled;                                                                    // 0x00D0 (size: 0x1)
...
struct FRigUnit_DebugTransform : public FRigUnit_DebugBase
{
    ...
    char padding_1[0xC];                                                              // 0x0064 (size: 0xC)
...
struct FRigUnit_DebugTransformArrayMutable : public FRigUnit_DebugBaseMutable
{
    ...
    FName Space;                                                                      // 0x0094 (size: 0x8)
    char padding_1[0x4];                                                              // 0x009C (size: 0x4)
    FTransform WorldOffset;                                                           // 0x00A0 (size: 0x30)
    bool bEnabled;                                                                    // 0x00D0 (size: 0x1)
    char padding_2[0x7];                                                              // 0x00D1 (size: 0x7)
...
struct FRigUnit_DebugTransformMutable : public FRigUnit_DebugBaseMutable
{
    ...
    char padding_1[0xC];                                                              // 0x00C4 (size: 0xC)
    FTransform WorldOffset;                                                           // 0x00D0 (size: 0x30)
    bool bEnabled;                                                                    // 0x0100 (size: 0x1)
...
struct FRigUnit_DebugTransformMutableItemSpace : public FRigUnit_DebugBaseMutable
{
    ...
    char padding_1[0x8];                                                              // 0x00C8 (size: 0x8)
    FTransform WorldOffset;                                                           // 0x00D0 (size: 0x30)
    bool bEnabled;                                                                    // 0x0100 (size: 0x1)
...
struct FRigUnit_DistributeRotation : public FRigUnit_HighlevelBaseMutable
{
    ...
    char padding_1[0x7];                                                              // 0x0091 (size: 0x7)
...
struct FRigUnit_FABRIK : public FRigUnit_HighlevelBaseMutable
{
    ...
    char padding_1[0x3];                                                              // 0x00B9 (size: 0x3)
...
struct FRigUnit_GetJointTransform : public FRigUnitMutable
{
    ...
    char padding_1[0x8];                                                              // 0x00B8 (size: 0x8)
...
struct FRigUnit_GetRelativeTransformForItem : public FRigUnit
{
    ...
    char padding_1[0xB];                                                              // 0x0025 (size: 0xB)
...
struct FRigUnit_GetTransform : public FRigUnit
{
    ...
    char padding_0[0xA];                                                              // 0x0016 (size: 0xA)
    FTransform Transform;                                                             // 0x0020 (size: 0x30)
...
struct FRigUnit_HierarchyGetChildren : public FRigUnit_HierarchyBase
{
    ...
    bool bIncludeParent;                                                              // 0x0014 (size: 0x1)
    bool bRecursive;                                                                  // 0x0015 (size: 0x1)
    char padding_0[0x2];                                                              // 0x0016 (size: 0x2)
...
struct FRigUnit_ItemHarmonics : public FRigUnit_HighlevelBaseMutable
{
    ...
    float WaveMaximum;                                                                // 0x00BC (size: 0x4)
    EControlRigRotationOrder RotationOrder;                                           // 0x00C0 (size: 0x1)
    char padding_1[0x7];                                                              // 0x00C1 (size: 0x7)
    FRigUnit_BoneHarmonics_WorkData WorkData;                                         // 0x00C8 (size: 0x20)
...
struct FRigUnit_MathRBFInterpolateQuatBase : public FRigUnit_MathRBFInterpolateBase
{
    ...
    char padding_2[0x8];                                                              // 0x0038 (size: 0x8)
...
struct FRigUnit_MathTransformClampSpatially : public FRigUnit_MathTransformBase
{
    ...
    char padding_3[0x8];                                                              // 0x0098 (size: 0x8)
    FTransform Result;                                                                // 0x00A0 (size: 0x30)
...
struct FRigUnit_MathTransformLerp : public FRigUnit_MathTransformBase
{
    ...
    char padding_0[0xC];                                                              // 0x0074 (size: 0xC)
    FTransform Result;                                                                // 0x0080 (size: 0x30)
...
struct FRigUnit_ModifyBoneTransforms : public FRigUnit_HighlevelBaseMutable
{
    ...
    char padding_0[0x3];                                                              // 0x0085 (size: 0x3)
...
struct FRigUnit_PointSimulation : public FRigUnit_SimBaseMutable
{
    ...
    char padding_1[0x4];                                                              // 0x00B4 (size: 0x4)
    ...
    char padding_3[0xC];                                                              // 0x00E4 (size: 0xC)
...
struct FRigUnit_ProjectTransformToNewParent : public FRigUnit
{
    ...
    char padding_2[0xB];                                                              // 0x0035 (size: 0xB)
    FTransform Transform;                                                             // 0x0040 (size: 0x30)
...
struct FRigUnit_PropagateTransform : public FRigUnitMutable
{
    ...
    char padding_0[0x1];                                                              // 0x0077 (size: 0x1)
...
struct FRigUnit_SetBoneInitialTransform : public FRigUnitMutable
{
    ...
    char padding_0[0x2];                                                              // 0x00D2 (size: 0x2)
...
struct FRigUnit_SetBoneTransform : public FRigUnitMutable
{
    ...
    bool bPropagateToChildren;                                                        // 0x00D8 (size: 0x1)
    char padding_1[0x3];                                                              // 0x00D9 (size: 0x3)
...
struct FRigUnit_SetBoneTranslation : public FRigUnitMutable
{
    ...
    char padding_0[0x3];                                                              // 0x007D (size: 0x3)
    float Weight;                                                                     // 0x0080 (size: 0x4)
    bool bPropagateToChildren;                                                        // 0x0084 (size: 0x1)
    char padding_1[0x3];                                                              // 0x0085 (size: 0x3)
...
struct FRigUnit_SetMultiControlFloat : public FRigUnitMutable
{
    ...
    float Weight;                                                                     // 0x0078 (size: 0x4)
    char padding_0[0x4];                                                              // 0x007C (size: 0x4)
...
struct FRigUnit_SetRelativeTransformForItem : public FRigUnitMutable
{
    ...
    char padding_0[0xF];                                                              // 0x0081 (size: 0xF)
...
struct FRigUnit_SetRotation : public FRigUnitMutable
{
    ...
    char padding_1[0x3];                                                              // 0x0095 (size: 0x3)
...
struct FRigUnit_SetTransform : public FRigUnitMutable
{
    ...
    char padding_0[0xA];                                                              // 0x0076 (size: 0xA)
    FTransform Transform;                                                             // 0x0080 (size: 0x30)
    float Weight;                                                                     // 0x00B0 (size: 0x4)
    bool bPropagateToChildren;                                                        // 0x00B4 (size: 0x1)
    char padding_1[0x3];                                                              // 0x00B5 (size: 0x3)
...
struct FRigUnit_SpringIK : public FRigUnit_HighlevelBaseMutable
{
    ...
    char padding_0[0x2];                                                              // 0x009E (size: 0x2)
    ...
    bool bLimitLocalPosition;                                                         // 0x00C8 (size: 0x1)
    bool bPropagateToChildren;                                                        // 0x00C9 (size: 0x1)
    char padding_2[0x6];                                                              // 0x00CA (size: 0x6)
...
struct FRigUnit_TransformConstraint : public FRigUnit_HighlevelBaseMutable
{
    ...
    char padding_0[0xF];                                                              // 0x0071 (size: 0xF)
    FTransform BaseTransform;                                                         // 0x0080 (size: 0x30)
...
struct FRigUnit_TransformConstraintPerItem : public FRigUnit_HighlevelBaseMutable
{
    ...
    char padding_1[0x4];                                                              // 0x00BC (size: 0x4)
...
struct FRigUnit_TwistBones : public FRigUnit_HighlevelBaseMutable
{
    ...
    char padding_0[0x3];                                                              // 0x0091 (size: 0x3)
...
struct FRigUnit_TwoBoneIKFK : public FRigUnitMutable
{
    ...
    char padding_2[0xC];                                                              // 0x0164 (size: 0xC)
...
struct FRigUnit_TwoBoneIKSimplePerItem : public FRigUnit_HighlevelBaseMutable
{
    ...
    char padding_2[0x3];                                                              // 0x00F9 (size: 0x3)
    ...
    char padding_3[0xF];                                                              // 0x0111 (size: 0xF)
...
{
    class AActor* ActorToTrack;                                                       // 0x0228 (size: 0x8)
    TSubclassOf<class UControlRig> ControlRigClass;                                   // 0x0230 (size: 0x8)
    bool bRefreshOnTick;                                                              // 0x0238 (size: 0x1)
    bool bIsSelectable;                                                               // 0x0239 (size: 0x1)
    char padding_0[0x6];                                                              // 0x023A (size: 0x6)
    class UMaterialInterface* MaterialOverride;                                       // 0x0240 (size: 0x8)
    FString ColorParameter;                                                           // 0x0248 (size: 0x10)
    bool bCastShadows;                                                                // 0x0258 (size: 0x1)
    char padding_1[0x7];                                                              // 0x0259 (size: 0x7)
    class USceneComponent* ActorRootComponent;                                        // 0x0260 (size: 0x8)
    class UControlRig* ControlRig;                                                    // 0x0268 (size: 0x8)
    TArray<FName> ControlNames;                                                       // 0x0270 (size: 0x10)
    TArray<FTransform> GizmoTransforms;                                               // 0x0280 (size: 0x10)
    TArray<class UStaticMeshComponent*> Components;                                   // 0x0290 (size: 0x10)
    TArray<class UMaterialInstanceDynamic*> Materials;                                // 0x02A0 (size: 0x10)
    FName ColorParameterName;                                                         // 0x02B0 (size: 0x8)
...
{
    class USceneComponent* ActorRootComponent;                                        // 0x0228 (size: 0x8)
    class UStaticMeshComponent* StaticMeshComponent;                                  // 0x0230 (size: 0x8)
    uint32 ControlRigIndex;                                                           // 0x0238 (size: 0x4)
    FName ControlName;                                                                // 0x023C (size: 0x8)
    FName ColorParameterName;                                                         // 0x0244 (size: 0x8)
    uint8 bEnabled;                                                                   // 0x024C (size: 0x1)
    uint8 bSelected;                                                                  // 0x024C (size: 0x1)
    uint8 bSelectable;                                                                // 0x024C (size: 0x1)
    uint8 bHovered;                                                                   // 0x024C (size: 0x1)
...
class UControlRig : public UObject
{
    ...
    char padding_0[0x2];                                                              // 0x0046 (size: 0x2)
    ...
    char padding_1[0x10];                                                             // 0x03E0 (size: 0x10)
...
{
    TSubclassOf<class UControlRig> ControlRigClass;                                   // 0x0468 (size: 0x8)
    FControlRigComponentOnPostInitializeDelegate OnPostInitializeDelegate;            // 0x0470 (size: 0x10)
    void ControlRigComponentDelegate(class UControlRigComponent* Component);
    FControlRigComponentOnPreSetupDelegate OnPreSetupDelegate;                        // 0x0480 (size: 0x10)
    void ControlRigComponentDelegate(class UControlRigComponent* Component);
    FControlRigComponentOnPostSetupDelegate OnPostSetupDelegate;                      // 0x0490 (size: 0x10)
    void ControlRigComponentDelegate(class UControlRigComponent* Component);
    FControlRigComponentOnPreUpdateDelegate OnPreUpdateDelegate;                      // 0x04A0 (size: 0x10)
    void ControlRigComponentDelegate(class UControlRigComponent* Component);
    FControlRigComponentOnPostUpdateDelegate OnPostUpdateDelegate;                    // 0x04B0 (size: 0x10)
    void ControlRigComponentDelegate(class UControlRigComponent* Component);
    TArray<FControlRigComponentMappedElement> MappedElements;                         // 0x04C0 (size: 0x10)
    bool bResetTransformBeforeTick;                                                   // 0x04D0 (size: 0x1)
    bool bResetInitialsBeforeSetup;                                                   // 0x04D1 (size: 0x1)
    bool bUpdateRigOnTick;                                                            // 0x04D2 (size: 0x1)
    bool bUpdateInEditor;                                                             // 0x04D3 (size: 0x1)
    bool bDrawBones;                                                                  // 0x04D4 (size: 0x1)
    bool bShowDebugDrawing;                                                           // 0x04D5 (size: 0x1)
    char padding_0[0x2];                                                              // 0x04D6 (size: 0x2)
    class UControlRig* ControlRig;                                                    // 0x04D8 (size: 0x8)
...
{
    char padding_0[0x2D0];                                                            // 0x0000 (size: 0x0)
}; // Size: 0x2D0
...
class UMovieSceneControlRigParameterSection : public UMovieSceneParameterSection
{
    ...
    char padding_0[0x4];                                                              // 0x016C (size: 0x4)
