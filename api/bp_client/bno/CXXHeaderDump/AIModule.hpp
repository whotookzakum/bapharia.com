...
class UAIPerceptionComponent : public UActorComponent
{
    ...
    char padding_0[0x10];                                                             // 0x00D0 (size: 0x10)
    class AAIController* AIOwner;                                                     // 0x00E0 (size: 0x8)
    char padding_1[0x80];                                                             // 0x00E8 (size: 0x80)
...
class UBehaviorTreeComponent : public UBrainComponent
{
    ...
    char padding_0[0x140];                                                            // 0x0140 (size: 0x140)
    class UBehaviorTree* DefaultBehaviorTreeAsset;                                    // 0x0280 (size: 0x8)
...
class UBlackboardComponent : public UActorComponent
{
    ...
    char padding_0[0x20];                                                             // 0x00D0 (size: 0x20)
...
{
    FVector CrowdAgentMoveDirection;                                                  // 0x0280 (size: 0xC)
...
{
    class UNavLocalGridManager* GridManager;                                          // 0x0268 (size: 0x8)
...
{
    class APawn* ControlledPawn;                                                      // 0x00B8 (size: 0x8)
    TArray<FPawnActionStack> ActionStacks;                                            // 0x00C0 (size: 0x10)
    TArray<FPawnActionEvent> ActionEvents;                                            // 0x00D0 (size: 0x10)
    class UPawnAction* CurrentAction;                                                 // 0x00E0 (size: 0x8)
...
class UPawnSensingComponent : public UActorComponent
{
    ...
    char padding_0[0xB];                                                              // 0x00CD (size: 0xB)
