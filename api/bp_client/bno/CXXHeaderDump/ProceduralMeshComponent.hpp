...
{
    bool bUseComplexAsSimpleCollision;                                                // 0x0498 (size: 0x1)
    bool bUseAsyncCooking;                                                            // 0x0499 (size: 0x1)
    char padding_0[0x6];                                                              // 0x049A (size: 0x6)
    class UBodySetup* ProcMeshBodySetup;                                              // 0x04A0 (size: 0x8)
    TArray<FProcMeshSection> ProcMeshSections;                                        // 0x04A8 (size: 0x10)
    TArray<FKConvexElem> CollisionConvexElems;                                        // 0x04B8 (size: 0x10)
    FBoxSphereBounds LocalBounds;                                                     // 0x04C8 (size: 0x1C)
    char padding_1[0x4];                                                              // 0x04E4 (size: 0x4)
    TArray<class UBodySetup*> AsyncBodySetupQueue;                                    // 0x04E8 (size: 0x10)
