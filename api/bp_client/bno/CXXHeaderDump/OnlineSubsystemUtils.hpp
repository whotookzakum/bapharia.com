...
class APartyBeaconHost : public AOnlineBeaconHostObject
{
    ...
    char padding_0[0x60];                                                             // 0x0258 (size: 0x60)
...
{
    char padding_0[0x2B8];                                                            // 0x0000 (size: 0x0)
...
{
    float SocketErrorDisconnectDelay;                                                 // 0x1C08 (size: 0x4)

}; // Size: 0x1C58

class UIpNetDriver : public UNetDriver
{
    uint8 LogPortUnreach;                                                             // 0x0768 (size: 0x1)
    uint8 AllowPlayerPortUnreach;                                                     // 0x0768 (size: 0x1)
    char padding_0[0x3];                                                              // 0x0769 (size: 0x3)
    uint32 MaxPortCountToTry;                                                         // 0x076C (size: 0x4)
    char padding_1[0xC];                                                              // 0x0770 (size: 0xC)
    uint32 ServerDesiredSocketReceiveBufferBytes;                                     // 0x077C (size: 0x4)
    uint32 ServerDesiredSocketSendBufferBytes;                                        // 0x0780 (size: 0x4)
    uint32 ClientDesiredSocketReceiveBufferBytes;                                     // 0x0784 (size: 0x4)
    uint32 ClientDesiredSocketSendBufferBytes;                                        // 0x0788 (size: 0x4)
    char padding_2[0x4];                                                              // 0x078C (size: 0x4)
    double MaxSecondsInReceive;                                                       // 0x0790 (size: 0x8)
    int32 NbPacketsBetweenReceiveTimeTest;                                            // 0x0798 (size: 0x4)
    float ResolutionConnectionTimeout;                                                // 0x079C (size: 0x4)
