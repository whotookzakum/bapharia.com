...
{
    uint8 bFractureEffectOverride;                                                    // 0x06C0 (size: 0x1)
    char padding_0[0x7];                                                              // 0x06C1 (size: 0x7)
    TArray<FFractureEffect> FractureEffects;                                          // 0x06C8 (size: 0x10)
    bool bEnableHardSleeping;                                                         // 0x06D8 (size: 0x1)
    char padding_1[0x3];                                                              // 0x06D9 (size: 0x3)
    float LargeChunkThreshold;                                                        // 0x06DC (size: 0x4)
    char padding_2[0x10];                                                             // 0x06E0 (size: 0x10)
    FDestructibleComponentOnComponentFracture OnComponentFracture;                    // 0x06F0 (size: 0x10)
