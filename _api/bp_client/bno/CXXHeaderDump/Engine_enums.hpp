...
enum class EMeshBufferAccess {
    Default = 0,
    ForceCPUAndGPU = 1,
    ForcePositionOnlyCPUAndGPU = 2,
    EMeshBufferAccess_MAX = 3,
};
...
enum ESceneCaptureSource {
    ...
    SCS_FinalColorLDRSceneAlpha = 10,
    SCS_MAX = 11,
};
...
enum TextureGroup {
    ...
    TEXTUREGROUP_Project11 = 45,
    TEXTUREGROUP_Project12 = 46,
    TEXTUREGROUP_Project13 = 47,
    TEXTUREGROUP_Project14 = 48,
    TEXTUREGROUP_Project15 = 49,
    TEXTUREGROUP_MAX = 50,
};
