...
struct FMovieSceneRootEvaluationTemplateInstance
{
    ...
    char padding_1[0x70];                                                             // 0x0020 (size: 0x70)
...
struct FMovieSceneSpawnable
{
    ...
    char padding_0[0x1];                                                              // 0x0043 (size: 0x1)
...
struct FMovieSceneSubSequenceData
{
    ...
    char padding_1[0x1];                                                              // 0x00D7 (size: 0x1)
    FMovieSceneSequenceInstanceDataPtr InstanceData;                                  // 0x00D8 (size: 0x18)
    char padding_2[0x8];                                                              // 0x00F0 (size: 0x8)
...
struct FMovieSceneTrackEvaluationFieldEntry
{
    ...
    char padding_0[0x1];                                                              // 0x001D (size: 0x1)
...
class UMovieSceneBoolSection : public UMovieSceneSection
{
    ...
    char padding_0[0x7];                                                              // 0x00E9 (size: 0x7)
...
{
    FMovieSceneSequencePlayerOnPlay OnPlay;                                           // 0x0268 (size: 0x10)
    void OnMovieSceneSequencePlayerEvent();
    FMovieSceneSequencePlayerOnPlayReverse OnPlayReverse;                             // 0x0278 (size: 0x10)
    void OnMovieSceneSequencePlayerEvent();
    FMovieSceneSequencePlayerOnStop OnStop;                                           // 0x0288 (size: 0x10)
    void OnMovieSceneSequencePlayerEvent();
    FMovieSceneSequencePlayerOnPause OnPause;                                         // 0x0298 (size: 0x10)
    void OnMovieSceneSequencePlayerEvent();
    FMovieSceneSequencePlayerOnFinished OnFinished;                                   // 0x02A8 (size: 0x10)
    void OnMovieSceneSequencePlayerEvent();
    TEnumAsByte<EMovieScenePlayerStatus::Type> Status;                                // 0x02B8 (size: 0x1)
    char padding_0[0x3];                                                              // 0x02B9 (size: 0x3)
    uint8 bReversePlayback;                                                           // 0x02BC (size: 0x1)
    char padding_1[0x3];                                                              // 0x02BD (size: 0x3)
    class UMovieSceneSequence* Sequence;                                              // 0x02C0 (size: 0x8)
    FFrameNumber StartTime;                                                           // 0x02C8 (size: 0x4)
    int32 DurationFrames;                                                             // 0x02CC (size: 0x4)
    float DurationSubFrames;                                                          // 0x02D0 (size: 0x4)
    int32 CurrentNumLoops;                                                            // 0x02D4 (size: 0x4)
    FMovieSceneSequencePlaybackSettings PlaybackSettings;                             // 0x02D8 (size: 0x14)
    char padding_2[0x4];                                                              // 0x02EC (size: 0x4)
    FMovieSceneRootEvaluationTemplateInstance RootTemplateInstance;                   // 0x02F0 (size: 0xE8)
    char padding_3[0x68];                                                             // 0x03D8 (size: 0x68)
    FMovieSceneSequenceReplProperties NetSyncProps;                                   // 0x0440 (size: 0x10)
    TScriptInterface<class IMovieScenePlaybackClient> PlaybackClient;                 // 0x0450 (size: 0x10)
    class UMovieSceneSequenceTickManager* TickManager;                                // 0x0460 (size: 0x8)
...
{
    char padding_0[0x188];                                                            // 0x0000 (size: 0x0)
}; // Size: 0x188
...
class UMovieSceneTrack : public UMovieSceneSignedObject
{
    ...
    char padding_2[0x4];                                                              // 0x0068 (size: 0x4)
