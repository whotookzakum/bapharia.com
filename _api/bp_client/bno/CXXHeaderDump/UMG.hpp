...
{
    FTextBlockStyle TextStyle;                                                        // 0x0008 (size: 0x2A0)
...
{
    FMargin Padding;                                                                  // 0x0138 (size: 0x10)
    TEnumAsByte<EHorizontalAlignment> HorizontalAlignment;                            // 0x0148 (size: 0x1)
    TEnumAsByte<EVerticalAlignment> VerticalAlignment;                                // 0x0149 (size: 0x1)
    bool bApplyAlphaToBlur;                                                           // 0x014A (size: 0x1)
    char padding_0[0x1];                                                              // 0x014B (size: 0x1)
    float BlurStrength;                                                               // 0x014C (size: 0x4)
    bool bOverrideAutoRadiusCalculation;                                              // 0x0150 (size: 0x1)
    char padding_1[0x3];                                                              // 0x0151 (size: 0x3)
    int32 BlurRadius;                                                                 // 0x0154 (size: 0x4)
    FSlateBrush LowQualityFallbackBrush;                                              // 0x0158 (size: 0x88)
    float AdjustColorToneWeight;                                                      // 0x01E0 (size: 0x4)
...
class UBorder : public UContentWidget
{
    ...
    uint8 bShowEffectWhenDisabled;                                                    // 0x013A (size: 0x1)
    char padding_0[0x1];                                                              // 0x013B (size: 0x1)
    FLinearColor ContentColorAndOpacity;                                              // 0x013C (size: 0x10)
    FBorderContentColorAndOpacityDelegate ContentColorAndOpacityDelegate;             // 0x014C (size: 0x10)
    FLinearColor GetLinearColor();
    FMargin Padding;                                                                  // 0x015C (size: 0x10)
    char padding_1[0x4];                                                              // 0x016C (size: 0x4)
    FSlateBrush Background;                                                           // 0x0170 (size: 0x88)
    FBorderBackgroundDelegate BackgroundDelegate;                                     // 0x01F8 (size: 0x10)
    FSlateBrush GetSlateBrush();
    FLinearColor BrushColor;                                                          // 0x0208 (size: 0x10)
    FBorderBrushColorDelegate BrushColorDelegate;                                     // 0x0218 (size: 0x10)
    FLinearColor GetLinearColor();
    FVector2D DesiredSizeScale;                                                       // 0x0228 (size: 0x8)
    bool bFlipForRightToLeftFlowDirection;                                            // 0x0230 (size: 0x1)
    char padding_2[0x3];                                                              // 0x0231 (size: 0x3)
    FBorderOnMouseButtonDownEvent OnMouseButtonDownEvent;                             // 0x0234 (size: 0x10)
    FEventReply OnPointerEvent(FGeometry MyGeometry, const FPointerEvent& MouseEvent);
    FBorderOnMouseButtonUpEvent OnMouseButtonUpEvent;                                 // 0x0244 (size: 0x10)
    FEventReply OnPointerEvent(FGeometry MyGeometry, const FPointerEvent& MouseEvent);
    FBorderOnMouseMoveEvent OnMouseMoveEvent;                                         // 0x0254 (size: 0x10)
    FEventReply OnPointerEvent(FGeometry MyGeometry, const FPointerEvent& MouseEvent);
    FBorderOnMouseDoubleClickEvent OnMouseDoubleClickEvent;                           // 0x0264 (size: 0x10)
    FEventReply OnPointerEvent(FGeometry MyGeometry, const FPointerEvent& MouseEvent);
...
class UButton : public UContentWidget
{
    ...
    bool bIsDisableCursorNavi;                                                        // 0x03DC (size: 0x1)
    bool bUseDisabledColor;                                                           // 0x03DD (size: 0x1)
    char padding_0[0x2];                                                              // 0x03DE (size: 0x2)
    FButtonOnClicked OnClicked;                                                       // 0x03E0 (size: 0x10)
    void OnButtonClickedEvent();
    FButtonOnPressed OnPressed;                                                       // 0x03F0 (size: 0x10)
    void OnButtonPressedEvent();
    FButtonOnReleased OnReleased;                                                     // 0x0400 (size: 0x10)
    void OnButtonReleasedEvent();
    FButtonOnHovered OnHovered;                                                       // 0x0410 (size: 0x10)
    void OnButtonHoverEvent();
    FButtonOnUnhovered OnUnhovered;                                                   // 0x0420 (size: 0x10)
    void OnButtonHoverEvent();
...
{
    ECheckBoxState CheckedState;                                                      // 0x0138 (size: 0x1)
    char padding_0[0x3];                                                              // 0x0139 (size: 0x3)
    FCheckBoxCheckedStateDelegate CheckedStateDelegate;                               // 0x013C (size: 0x10)
    ECheckBoxState GetCheckBoxState();
    char padding_1[0x4];                                                              // 0x014C (size: 0x4)
    FCheckBoxStyle WidgetStyle;                                                       // 0x0150 (size: 0x580)
    class USlateWidgetStyleAsset* Style;                                              // 0x06D0 (size: 0x8)
    class USlateBrushAsset* UncheckedImage;                                           // 0x06D8 (size: 0x8)
    class USlateBrushAsset* UncheckedHoveredImage;                                    // 0x06E0 (size: 0x8)
    class USlateBrushAsset* UncheckedPressedImage;                                    // 0x06E8 (size: 0x8)
    class USlateBrushAsset* CheckedImage;                                             // 0x06F0 (size: 0x8)
    class USlateBrushAsset* CheckedHoveredImage;                                      // 0x06F8 (size: 0x8)
    class USlateBrushAsset* CheckedPressedImage;                                      // 0x0700 (size: 0x8)
    class USlateBrushAsset* UndeterminedImage;                                        // 0x0708 (size: 0x8)
    class USlateBrushAsset* UndeterminedHoveredImage;                                 // 0x0710 (size: 0x8)
    class USlateBrushAsset* UndeterminedPressedImage;                                 // 0x0718 (size: 0x8)
    TEnumAsByte<EHorizontalAlignment> HorizontalAlignment;                            // 0x0720 (size: 0x1)
    char padding_2[0x3];                                                              // 0x0721 (size: 0x3)
    FMargin Padding;                                                                  // 0x0724 (size: 0x10)
    char padding_3[0x4];                                                              // 0x0734 (size: 0x4)
    FSlateColor BorderBackgroundColor;                                                // 0x0738 (size: 0x28)
    TEnumAsByte<EButtonClickMethod::Type> ClickMethod;                                // 0x0760 (size: 0x1)
    TEnumAsByte<EButtonTouchMethod::Type> TouchMethod;                                // 0x0761 (size: 0x1)
    TEnumAsByte<EButtonPressMethod::Type> PressMethod;                                // 0x0762 (size: 0x1)
    bool IsFocusable;                                                                 // 0x0763 (size: 0x1)
    char padding_4[0x4];                                                              // 0x0764 (size: 0x4)
    FCheckBoxOnCheckStateChanged OnCheckStateChanged;                                 // 0x0768 (size: 0x10)
...
{
    int32 NumberOfPieces;                                                             // 0x0120 (size: 0x4)
    float Period;                                                                     // 0x0124 (size: 0x4)
    float Radius;                                                                     // 0x0128 (size: 0x4)
    char padding_0[0x4];                                                              // 0x012C (size: 0x4)
    class USlateBrushAsset* PieceImage;                                               // 0x0130 (size: 0x8)
    FSlateBrush Image;                                                                // 0x0138 (size: 0x88)
    bool bEnableRadius;                                                               // 0x01C0 (size: 0x1)
...
{
    TArray<class UObject*> Items;                                                     // 0x0120 (size: 0x10)
    FComboBoxOnGenerateWidgetEvent OnGenerateWidgetEvent;                             // 0x0130 (size: 0x10)
    class UWidget* GenerateWidgetForObject(class UObject* item);
    bool bIsFocusable;                                                                // 0x0140 (size: 0x1)

}; // Size: 0x158

class UComboBoxString : public UWidget
{
    TArray<FString> DefaultOptions;                                                   // 0x0120 (size: 0x10)
    FString SelectedOption;                                                           // 0x0130 (size: 0x10)
    FComboBoxStyle WidgetStyle;                                                       // 0x0140 (size: 0x3F0)
    FTableRowStyle ItemStyle;                                                         // 0x0530 (size: 0x7C8)
    FMargin ContentPadding;                                                           // 0x0CF8 (size: 0x10)
    float MaxListHeight;                                                              // 0x0D08 (size: 0x4)
    bool HasDownArrow;                                                                // 0x0D0C (size: 0x1)
    bool EnableGamepadNavigationMode;                                                 // 0x0D0D (size: 0x1)
    char padding_0[0x2];                                                              // 0x0D0E (size: 0x2)
    FSlateFontInfo Font;                                                              // 0x0D10 (size: 0x88)
    FSlateColor ForegroundColor;                                                      // 0x0D98 (size: 0x28)
    bool bIsFocusable;                                                                // 0x0DC0 (size: 0x1)
    char padding_1[0x3];                                                              // 0x0DC1 (size: 0x3)
    FComboBoxStringOnGenerateWidgetEvent OnGenerateWidgetEvent;                       // 0x0DC4 (size: 0x10)
    class UWidget* GenerateWidgetForString(FString item);
    char padding_2[0x4];                                                              // 0x0DD4 (size: 0x4)
    FComboBoxStringOnSelectionChanged OnSelectionChanged;                             // 0x0DD8 (size: 0x10)
    void OnSelectionChangedEvent(FString SelectedItem, TEnumAsByte<ESelectInfo::Type> SelectionType);
    FComboBoxStringOnOpening OnOpening;                                               // 0x0DE8 (size: 0x10)
    void OnOpeningEvent();
    FComboBoxStringOnClosing OnClosing;                                               // 0x0DF8 (size: 0x10)
    void OnClosingEvent();

    void SetSelectedOptionAt(const int32 Index);
...
{
    TSubclassOf<class UUserWidget> EntryWidgetClass;                                  // 0x01F0 (size: 0x8)
...
{
    EDynamicBoxType EntryBoxType;                                                     // 0x0120 (size: 0x1)
    char padding_0[0x3];                                                              // 0x0121 (size: 0x3)
    FVector2D EntrySpacing;                                                           // 0x0124 (size: 0x8)
    char padding_1[0x4];                                                              // 0x012C (size: 0x4)
    TArray<FVector2D> SpacingPattern;                                                 // 0x0130 (size: 0x10)
    FSlateChildSize EntrySizeRule;                                                    // 0x0140 (size: 0x8)
    TEnumAsByte<EHorizontalAlignment> EntryHorizontalAlignment;                       // 0x0148 (size: 0x1)
    TEnumAsByte<EVerticalAlignment> EntryVerticalAlignment;                           // 0x0149 (size: 0x1)
    char padding_2[0x2];                                                              // 0x014A (size: 0x2)
    int32 MaxElementSize;                                                             // 0x014C (size: 0x4)
    FRadialBoxSettings RadialBoxSettings;                                             // 0x0150 (size: 0x10)
    char padding_3[0x10];                                                             // 0x0160 (size: 0x10)
    FUserWidgetPool EntryWidgetPool;                                                  // 0x0170 (size: 0x80)
...
{
    FVector2D Margin;                                                                 // 0x0138 (size: 0x8)
    float Curve;                                                                      // 0x0140 (size: 0x4)

    void SetMargin(FVector2D InMargine);
...
class UEditableText : public UWidget
{
    ...
    FEditableTextTextDelegate TextDelegate;                                           // 0x0138 (size: 0x10)
    FText GetText();
    FText HintText;                                                                   // 0x0148 (size: 0x18)
    FEditableTextHintTextDelegate HintTextDelegate;                                   // 0x0160 (size: 0x10)
    FText GetText();
    FEditableTextStyle WidgetStyle;                                                   // 0x0170 (size: 0x250)
    class USlateWidgetStyleAsset* Style;                                              // 0x03C0 (size: 0x8)
    class USlateBrushAsset* BackgroundImageSelected;                                  // 0x03C8 (size: 0x8)
    class USlateBrushAsset* BackgroundImageComposing;                                 // 0x03D0 (size: 0x8)
    class USlateBrushAsset* CaretImage;                                               // 0x03D8 (size: 0x8)
    FSlateFontInfo Font;                                                              // 0x03E0 (size: 0x88)
    FSlateColor ColorAndOpacity;                                                      // 0x0468 (size: 0x28)
    bool IsReadOnly;                                                                  // 0x0490 (size: 0x1)
    bool IsPassword;                                                                  // 0x0491 (size: 0x1)
    char padding_0[0x2];                                                              // 0x0492 (size: 0x2)
    ...
    FShapedTextOptions ShapedTextOptions;                                             // 0x04A3 (size: 0x3)
    char padding_1[0x2];                                                              // 0x04A6 (size: 0x2)
...
{
    FText Text;                                                                       // 0x0120 (size: 0x18)
    FEditableTextBoxTextDelegate TextDelegate;                                        // 0x0138 (size: 0x10)
    FText GetText();
    FEditableTextBoxStyle WidgetStyle;                                                // 0x0148 (size: 0x838)
    class USlateWidgetStyleAsset* Style;                                              // 0x0980 (size: 0x8)
    FText HintText;                                                                   // 0x0988 (size: 0x18)
    FEditableTextBoxHintTextDelegate HintTextDelegate;                                // 0x09A0 (size: 0x10)
    FText GetText();
    FSlateFontInfo Font;                                                              // 0x09B0 (size: 0x88)
    FLinearColor ForegroundColor;                                                     // 0x0A38 (size: 0x10)
    FLinearColor BackgroundColor;                                                     // 0x0A48 (size: 0x10)
    FLinearColor ReadOnlyForegroundColor;                                             // 0x0A58 (size: 0x10)
    bool IsReadOnly;                                                                  // 0x0A68 (size: 0x1)
    bool IsPassword;                                                                  // 0x0A69 (size: 0x1)
    char padding_0[0x2];                                                              // 0x0A6A (size: 0x2)
    float MinimumDesiredWidth;                                                        // 0x0A6C (size: 0x4)
    FMargin Padding;                                                                  // 0x0A70 (size: 0x10)
    bool IsCaretMovedWhenGainFocus;                                                   // 0x0A80 (size: 0x1)
    bool SelectAllTextWhenFocused;                                                    // 0x0A81 (size: 0x1)
    bool RevertTextOnEscape;                                                          // 0x0A82 (size: 0x1)
    bool ClearKeyboardFocusOnCommit;                                                  // 0x0A83 (size: 0x1)
    bool SelectAllTextOnCommit;                                                       // 0x0A84 (size: 0x1)
    bool AllowContextMenu;                                                            // 0x0A85 (size: 0x1)
    TEnumAsByte<EVirtualKeyboardType::Type> KeyboardType;                             // 0x0A86 (size: 0x1)
    FVirtualKeyboardOptions VirtualKeyboardOptions;                                   // 0x0A87 (size: 0x1)
    EVirtualKeyboardTrigger VirtualKeyboardTrigger;                                   // 0x0A88 (size: 0x1)
    EVirtualKeyboardDismissAction VirtualKeyboardDismissAction;                       // 0x0A89 (size: 0x1)
    TEnumAsByte<ETextJustify::Type> Justification;                                    // 0x0A8A (size: 0x1)
    FShapedTextOptions ShapedTextOptions;                                             // 0x0A8B (size: 0x3)
    char padding_1[0x2];                                                              // 0x0A8E (size: 0x2)
    FEditableTextBoxOnTextChanged OnTextChanged;                                      // 0x0A90 (size: 0x10)
    void OnEditableTextBoxChangedEvent(const FText& Text);
    FEditableTextBoxOnTextCommitted OnTextCommitted;                                  // 0x0AA0 (size: 0x10)
...
{
    FExpandableAreaStyle Style;                                                       // 0x0128 (size: 0x120)
    FSlateBrush BorderBrush;                                                          // 0x0248 (size: 0x88)
    FSlateColor BorderColor;                                                          // 0x02D0 (size: 0x28)
    bool bIsExpanded;                                                                 // 0x02F8 (size: 0x1)
    char padding_0[0x3];                                                              // 0x02F9 (size: 0x3)
    float MaxHeight;                                                                  // 0x02FC (size: 0x4)
    FMargin HeaderPadding;                                                            // 0x0300 (size: 0x10)
    FMargin AreaPadding;                                                              // 0x0310 (size: 0x10)
    FExpandableAreaOnExpansionChanged OnExpansionChanged;                             // 0x0320 (size: 0x10)
    void OnExpandableAreaExpansionChanged(class UExpandableArea* Area, bool bIsExpanded);
    class UWidget* HeaderContent;                                                     // 0x0330 (size: 0x8)
    class UWidget* BodyContent;                                                       // 0x0338 (size: 0x8)
...
{
    TArray<float> ColumnFill;                                                         // 0x0138 (size: 0x10)
    TArray<float> RowFill;                                                            // 0x0148 (size: 0x10)
...
{
    FSlateBrush Brush;                                                                // 0x0120 (size: 0x88)
    FImageBrushDelegate BrushDelegate;                                                // 0x01A8 (size: 0x10)
    FSlateBrush GetSlateBrush();
    FLinearColor ColorAndOpacity;                                                     // 0x01B8 (size: 0x10)
    FImageColorAndOpacityDelegate ColorAndOpacityDelegate;                            // 0x01C8 (size: 0x10)
    FLinearColor GetLinearColor();
    bool bFlipForRightToLeftFlowDirection;                                            // 0x01D8 (size: 0x1)
    bool bNoPixelSnapping;                                                            // 0x01D9 (size: 0x1)
    char padding_0[0x2];                                                              // 0x01DA (size: 0x2)
    FImageBNoPixelSnappingDelegate bNoPixelSnappingDelegate;                          // 0x01DC (size: 0x10)
    bool GetBool();
    FImageOnMouseButtonDownEvent OnMouseButtonDownEvent;                              // 0x01EC (size: 0x10)
    FEventReply OnPointerEvent(FGeometry MyGeometry, const FPointerEvent& MouseEvent);
...
{
    FButtonStyle WidgetStyle;                                                         // 0x0120 (size: 0x278)
    FTextBlockStyle TextStyle;                                                        // 0x0398 (size: 0x2A0)
    FInputChord SelectedKey;                                                          // 0x0638 (size: 0x20)
    FSlateFontInfo Font;                                                              // 0x0658 (size: 0x88)
    FMargin Margin;                                                                   // 0x06E0 (size: 0x10)
    FLinearColor ColorAndOpacity;                                                     // 0x06F0 (size: 0x10)
    FText KeySelectionText;                                                           // 0x0700 (size: 0x18)
    FText NoKeySpecifiedText;                                                         // 0x0718 (size: 0x18)
    bool bAllowModifierKeys;                                                          // 0x0730 (size: 0x1)
    bool bAllowGamepadKeys;                                                           // 0x0731 (size: 0x1)
    char padding_0[0x6];                                                              // 0x0732 (size: 0x6)
    TArray<FKey> EscapeKeys;                                                          // 0x0738 (size: 0x10)
    FInputKeySelectorOnKeySelected OnKeySelected;                                     // 0x0748 (size: 0x10)
    void OnKeySelected(FInputChord SelectedKey);
    FInputKeySelectorOnIsSelectingKeyChanged OnIsSelectingKeyChanged;                 // 0x0758 (size: 0x10)
...
{
    bool bCanCache;                                                                   // 0x0138 (size: 0x1)
    bool CacheRelativeTransforms;                                                     // 0x0139 (size: 0x1)
...
{
    TEnumAsByte<EOrientation> Orientation;                                            // 0x02F0 (size: 0x1)
    TEnumAsByte<ESelectionMode::Type> SelectionMode;                                  // 0x02F1 (size: 0x1)
    EConsumeMouseWheel ConsumeMouseWheel;                                             // 0x02F2 (size: 0x1)
    bool bClearSelectionOnClick;                                                      // 0x02F3 (size: 0x1)
    bool bIsFocusable;                                                                // 0x02F4 (size: 0x1)
    char padding_0[0x3];                                                              // 0x02F5 (size: 0x3)
    float EntrySpacing;                                                               // 0x02F8 (size: 0x4)
    bool bReturnFocusToSelection;                                                     // 0x02FC (size: 0x1)
    char padding_1[0x3];                                                              // 0x02FD (size: 0x3)
    TArray<class UObject*> ListItems;                                                 // 0x0300 (size: 0x10)
    FScrollBarStyle ScrollBarStyle;                                                   // 0x0310 (size: 0x4E0)
    float ScrollBarSize;                                                              // 0x07F0 (size: 0x4)
    bool AlwaysShowScrollbar;                                                         // 0x07F4 (size: 0x1)
    char padding_2[0x13];                                                             // 0x07F5 (size: 0x13)
    FListViewBP_OnEntryInitialized BP_OnEntryInitialized;                             // 0x0808 (size: 0x10)
    void OnListEntryInitializedDynamic(class UObject* item, class UUserWidget* Widget);
    FListViewBP_OnItemClicked BP_OnItemClicked;                                       // 0x0818 (size: 0x10)
    void SimpleListItemEventDynamic(class UObject* item);
    FListViewBP_OnItemDoubleClicked BP_OnItemDoubleClicked;                           // 0x0828 (size: 0x10)
    void SimpleListItemEventDynamic(class UObject* item);
    FListViewBP_OnItemIsHoveredChanged BP_OnItemIsHoveredChanged;                     // 0x0838 (size: 0x10)
    void OnItemIsHoveredChangedDynamic(class UObject* item, bool bIsHovered);
    FListViewBP_OnItemSelectionChanged BP_OnItemSelectionChanged;                     // 0x0848 (size: 0x10)
    void OnListItemSelectionChangedDynamic(class UObject* item, bool bIsSelected);
    FListViewBP_OnItemScrolledIntoView BP_OnItemScrolledIntoView;                     // 0x0858 (size: 0x10)
...
{
    TSubclassOf<class UUserWidget> EntryWidgetClass;                                  // 0x0120 (size: 0x8)
    float WheelScrollMultiplier;                                                      // 0x0128 (size: 0x4)
    bool bEnableScrollAnimation;                                                      // 0x012C (size: 0x1)
    bool bEnableFixedLineOffset;                                                      // 0x012D (size: 0x1)
    char padding_0[0x2];                                                              // 0x012E (size: 0x2)
    float FixedLineScrollOffset;                                                      // 0x0130 (size: 0x4)
    char padding_1[0x4];                                                              // 0x0134 (size: 0x4)
    FListViewBaseBP_OnEntryGenerated BP_OnEntryGenerated;                             // 0x0138 (size: 0x10)
    void OnListEntryGeneratedDynamic(class UUserWidget* Widget);
    FListViewBaseBP_OnEntryReleased BP_OnEntryReleased;                               // 0x0148 (size: 0x10)
...
{
    TSubclassOf<class UUserWidget> MenuClass;                                         // 0x0138 (size: 0x8)
    FMenuAnchorOnGetMenuContentEvent OnGetMenuContentEvent;                           // 0x0140 (size: 0x10)
    class UWidget* GetWidget();
    FMenuAnchorOnGetUserMenuContentEvent OnGetUserMenuContentEvent;                   // 0x0150 (size: 0x10)
    class UUserWidget* GetUserWidget();
    TEnumAsByte<EMenuPlacement> Placement;                                            // 0x0160 (size: 0x1)
    bool bFitInWindow;                                                                // 0x0161 (size: 0x1)
    bool ShouldDeferPaintingAfterWindowContent;                                       // 0x0162 (size: 0x1)
    bool UseApplicationMenuStack;                                                     // 0x0163 (size: 0x1)
    char padding_0[0x4];                                                              // 0x0164 (size: 0x4)
    FMenuAnchorOnMenuOpenChanged OnMenuOpenChanged;                                   // 0x0168 (size: 0x10)
...
class UMultiLineEditableText : public UTextLayoutWidget
{
    ...
    FText HintText;                                                                   // 0x0158 (size: 0x18)
    FMultiLineEditableTextHintTextDelegate HintTextDelegate;                          // 0x0170 (size: 0x10)
    FText GetText();
    FTextBlockStyle WidgetStyle;                                                      // 0x0180 (size: 0x2A0)
    bool bIsReadOnly;                                                                 // 0x0420 (size: 0x1)
    char padding_0[0x7];                                                              // 0x0421 (size: 0x7)
    FSlateFontInfo Font;                                                              // 0x0428 (size: 0x88)
    bool SelectAllTextWhenFocused;                                                    // 0x04B0 (size: 0x1)
    bool ClearTextSelectionOnFocusLoss;                                               // 0x04B1 (size: 0x1)
    bool RevertTextOnEscape;                                                          // 0x04B2 (size: 0x1)
    bool ClearKeyboardFocusOnCommit;                                                  // 0x04B3 (size: 0x1)
    bool AllowContextMenu;                                                            // 0x04B4 (size: 0x1)
    FVirtualKeyboardOptions VirtualKeyboardOptions;                                   // 0x04B5 (size: 0x1)
    EVirtualKeyboardDismissAction VirtualKeyboardDismissAction;                       // 0x04B6 (size: 0x1)
    char padding_1[0x1];                                                              // 0x04B7 (size: 0x1)
    FMultiLineEditableTextOnTextChanged OnTextChanged;                                // 0x04B8 (size: 0x10)
    void OnMultiLineEditableTextChangedEvent(const FText& Text);
    FMultiLineEditableTextOnTextCommitted OnTextCommitted;                            // 0x04C8 (size: 0x10)
...
class UMultiLineEditableTextBox : public UTextLayoutWidget
{
    FText Text;                                                                       // 0x0140 (size: 0x18)
    FText HintText;                                                                   // 0x0158 (size: 0x18)
    FMultiLineEditableTextBoxHintTextDelegate HintTextDelegate;                       // 0x0170 (size: 0x10)
    FText GetText();
    FEditableTextBoxStyle WidgetStyle;                                                // 0x0180 (size: 0x838)
    FTextBlockStyle TextStyle;                                                        // 0x09B8 (size: 0x2A0)
    bool bIsReadOnly;                                                                 // 0x0C58 (size: 0x1)
    bool AllowContextMenu;                                                            // 0x0C59 (size: 0x1)
    FVirtualKeyboardOptions VirtualKeyboardOptions;                                   // 0x0C5A (size: 0x1)
    EVirtualKeyboardDismissAction VirtualKeyboardDismissAction;                       // 0x0C5B (size: 0x1)
    char padding_0[0x4];                                                              // 0x0C5C (size: 0x4)
    class USlateWidgetStyleAsset* Style;                                              // 0x0C60 (size: 0x8)
    FSlateFontInfo Font;                                                              // 0x0C68 (size: 0x88)
    FLinearColor ForegroundColor;                                                     // 0x0CF0 (size: 0x10)
    FLinearColor BackgroundColor;                                                     // 0x0D00 (size: 0x10)
    FLinearColor ReadOnlyForegroundColor;                                             // 0x0D10 (size: 0x10)
    FMultiLineEditableTextBoxOnTextChanged OnTextChanged;                             // 0x0D20 (size: 0x10)
    void OnMultiLineEditableTextBoxChangedEvent(const FText& Text);
    FMultiLineEditableTextBoxOnTextCommitted OnTextCommitted;                         // 0x0D30 (size: 0x10)
...
{
    TArray<class UPanelSlot*> Slots;                                                  // 0x0120 (size: 0x10)
...
{
    FProgressBarStyle WidgetStyle;                                                    // 0x0120 (size: 0x1A0)
    class USlateWidgetStyleAsset* Style;                                              // 0x02C0 (size: 0x8)
    class USlateBrushAsset* BackgroundImage;                                          // 0x02C8 (size: 0x8)
    class USlateBrushAsset* FillImage;                                                // 0x02D0 (size: 0x8)
    class USlateBrushAsset* MarqueeImage;                                             // 0x02D8 (size: 0x8)
    float Percent;                                                                    // 0x02E0 (size: 0x4)
    TEnumAsByte<EProgressBarFillType::Type> BarFillType;                              // 0x02E4 (size: 0x1)
    bool bIsMarquee;                                                                  // 0x02E5 (size: 0x1)
    char padding_0[0x2];                                                              // 0x02E6 (size: 0x2)
    FVector2D BorderPadding;                                                          // 0x02E8 (size: 0x8)
    FProgressBarPercentDelegate PercentDelegate;                                      // 0x02F0 (size: 0x10)
    float GetFloat();
    FLinearColor FillColorAndOpacity;                                                 // 0x0300 (size: 0x10)
    FProgressBarFillColorAndOpacityDelegate FillColorAndOpacityDelegate;              // 0x0310 (size: 0x10)
    FLinearColor GetLinearColor();
...
class URetainerBox : public UContentWidget
{
    ...
    bool RenderOnInvalidation;                                                        // 0x0139 (size: 0x1)
    bool RenderOnPhase;                                                               // 0x013A (size: 0x1)
    char padding_0[0x1];                                                              // 0x013B (size: 0x1)
    int32 Phase;                                                                      // 0x013C (size: 0x4)
    int32 PhaseCount;                                                                 // 0x0140 (size: 0x4)
    char padding_1[0x4];                                                              // 0x0144 (size: 0x4)
    class UMaterialInterface* EffectMaterial;                                         // 0x0148 (size: 0x8)
    FName TextureParameter;                                                           // 0x0150 (size: 0x8)
...
{
    FText Text;                                                                       // 0x0140 (size: 0x18)
    class UDataTable* TextStyleSet;                                                   // 0x0158 (size: 0x8)
    TArray<class TSubclassOf<URichTextBlockDecorator>> DecoratorClasses;              // 0x0160 (size: 0x10)
    bool bOverrideDefaultStyle;                                                       // 0x0170 (size: 0x1)
    char padding_0[0x7];                                                              // 0x0171 (size: 0x7)
    FTextBlockStyle DefaultTextStyleOverride;                                         // 0x0178 (size: 0x2A0)
    float MinDesiredWidth;                                                            // 0x0418 (size: 0x4)
    ETextTransformPolicy TextTransformPolicy;                                         // 0x041C (size: 0x1)
    char padding_1[0x3];                                                              // 0x041D (size: 0x3)
    FTextBlockStyle DefaultTextStyle;                                                 // 0x0420 (size: 0x2A0)
    TArray<class URichTextBlockDecorator*> InstanceDecorators;                        // 0x06C0 (size: 0x10)
...
{
    bool PadLeft;                                                                     // 0x0138 (size: 0x1)
    bool PadRight;                                                                    // 0x0139 (size: 0x1)
    bool PadTop;                                                                      // 0x013A (size: 0x1)
    bool PadBottom;                                                                   // 0x013B (size: 0x1)
...
{
    TEnumAsByte<EStretch::Type> Stretch;                                              // 0x0138 (size: 0x1)
    TEnumAsByte<EStretchDirection::Type> StretchDirection;                            // 0x0139 (size: 0x1)
    char padding_0[0x2];                                                              // 0x013A (size: 0x2)
    float UserSpecifiedScale;                                                         // 0x013C (size: 0x4)
    bool IgnoreInheritedScale;                                                        // 0x0140 (size: 0x1)
...
{
    FScrollBarStyle WidgetStyle;                                                      // 0x0120 (size: 0x4E0)
    class USlateWidgetStyleAsset* Style;                                              // 0x0600 (size: 0x8)
    bool bAlwaysShowScrollbar;                                                        // 0x0608 (size: 0x1)
    bool bAlwaysShowScrollbarTrack;                                                   // 0x0609 (size: 0x1)
    TEnumAsByte<EOrientation> Orientation;                                            // 0x060A (size: 0x1)
    char padding_0[0x1];                                                              // 0x060B (size: 0x1)
    FVector2D Thickness;                                                              // 0x060C (size: 0x8)
    FMargin Padding;                                                                  // 0x0614 (size: 0x10)
...
{
    FScrollBoxStyle WidgetStyle;                                                      // 0x0138 (size: 0x228)
    FScrollBarStyle WidgetBarStyle;                                                   // 0x0360 (size: 0x4E0)
    class USlateWidgetStyleAsset* Style;                                              // 0x0840 (size: 0x8)
    class USlateWidgetStyleAsset* BarStyle;                                           // 0x0848 (size: 0x8)
    TEnumAsByte<EOrientation> Orientation;                                            // 0x0850 (size: 0x1)
    ESlateVisibility ScrollBarVisibility;                                             // 0x0851 (size: 0x1)
    EConsumeMouseWheel ConsumeMouseWheel;                                             // 0x0852 (size: 0x1)
    char padding_0[0x1];                                                              // 0x0853 (size: 0x1)
    FVector2D ScrollbarThickness;                                                     // 0x0854 (size: 0x8)
    FMargin ScrollbarPadding;                                                         // 0x085C (size: 0x10)
    bool AlwaysShowScrollbar;                                                         // 0x086C (size: 0x1)
    bool AlwaysShowScrollbarTrack;                                                    // 0x086D (size: 0x1)
    bool AllowOverscroll;                                                             // 0x086E (size: 0x1)
    bool bAnimateWheelScrolling;                                                      // 0x086F (size: 0x1)
    EDescendantScrollDestination NavigationDestination;                               // 0x0870 (size: 0x1)
    char padding_1[0x3];                                                              // 0x0871 (size: 0x3)
    float NavigationScrollPadding;                                                    // 0x0874 (size: 0x4)
    EScrollWhenFocusChanges ScrollWhenFocusChanges;                                   // 0x0878 (size: 0x1)
    bool bAllowRightClickDragScrolling;                                               // 0x0879 (size: 0x1)
    char padding_2[0x2];                                                              // 0x087A (size: 0x2)
    float WheelScrollMultiplier;                                                      // 0x087C (size: 0x4)
    FScrollBoxOnUserScrolled OnUserScrolled;                                          // 0x0880 (size: 0x10)
...
{
    float WidthOverride;                                                              // 0x0148 (size: 0x4)
    float HeightOverride;                                                             // 0x014C (size: 0x4)
    float MinDesiredWidth;                                                            // 0x0150 (size: 0x4)
    float MinDesiredHeight;                                                           // 0x0154 (size: 0x4)
    float MaxDesiredWidth;                                                            // 0x0158 (size: 0x4)
    float MaxDesiredHeight;                                                           // 0x015C (size: 0x4)
    float MinAspectRatio;                                                             // 0x0160 (size: 0x4)
    float MaxAspectRatio;                                                             // 0x0164 (size: 0x4)
    uint8 bOverride_WidthOverride;                                                    // 0x0168 (size: 0x1)
    uint8 bOverride_HeightOverride;                                                   // 0x0168 (size: 0x1)
    uint8 bOverride_MinDesiredWidth;                                                  // 0x0168 (size: 0x1)
    uint8 bOverride_MinDesiredHeight;                                                 // 0x0168 (size: 0x1)
    uint8 bOverride_MaxDesiredWidth;                                                  // 0x0168 (size: 0x1)
    uint8 bOverride_MaxDesiredHeight;                                                 // 0x0168 (size: 0x1)
    uint8 bOverride_MinAspectRatio;                                                   // 0x0168 (size: 0x1)
    uint8 bOverride_MaxAspectRatio;                                                   // 0x0168 (size: 0x1)
...
class USlider : public UWidget
{
    ...
    FSliderValueDelegate ValueDelegate;                                               // 0x0124 (size: 0x10)
    float GetFloat();
    float MinValue;                                                                   // 0x0134 (size: 0x4)
    float MaxValue;                                                                   // 0x0138 (size: 0x4)
    char padding_0[0x4];                                                              // 0x013C (size: 0x4)
    FSliderStyle WidgetStyle;                                                         // 0x0140 (size: 0x340)
    TEnumAsByte<EOrientation> Orientation;                                            // 0x0480 (size: 0x1)
    char padding_1[0x3];                                                              // 0x0481 (size: 0x3)
    FLinearColor SliderBarColor;                                                      // 0x0484 (size: 0x10)
    FLinearColor SliderHandleColor;                                                   // 0x0494 (size: 0x10)
    bool IndentHandle;                                                                // 0x04A4 (size: 0x1)
    bool locked;                                                                      // 0x04A5 (size: 0x1)
    bool MouseUsesStep;                                                               // 0x04A6 (size: 0x1)
    bool RequiresControllerLock;                                                      // 0x04A7 (size: 0x1)
    float StepSize;                                                                   // 0x04A8 (size: 0x4)
    bool IsFocusable;                                                                 // 0x04AC (size: 0x1)
    char padding_2[0x3];                                                              // 0x04AD (size: 0x3)
    FSliderOnMouseCaptureBegin OnMouseCaptureBegin;                                   // 0x04B0 (size: 0x10)
    void OnMouseCaptureBeginEvent();
    FSliderOnMouseCaptureEnd OnMouseCaptureEnd;                                       // 0x04C0 (size: 0x10)
    void OnMouseCaptureEndEvent();
    FSliderOnControllerCaptureBegin OnControllerCaptureBegin;                         // 0x04D0 (size: 0x10)
    void OnControllerCaptureBeginEvent();
    FSliderOnControllerCaptureEnd OnControllerCaptureEnd;                             // 0x04E0 (size: 0x10)
    void OnControllerCaptureEndEvent();
    FSliderOnValueChanged OnValueChanged;                                             // 0x04F0 (size: 0x10)
...
{
    FVector2D Size;                                                                   // 0x0120 (size: 0x8)
...
{
    float Value;                                                                      // 0x0120 (size: 0x4)
    FSpinBoxValueDelegate ValueDelegate;                                              // 0x0124 (size: 0x10)
    float GetFloat();
    char padding_0[0x4];                                                              // 0x0134 (size: 0x4)
    FSpinBoxStyle WidgetStyle;                                                        // 0x0138 (size: 0x2E8)
    class USlateWidgetStyleAsset* Style;                                              // 0x0420 (size: 0x8)
    int32 MinFractionalDigits;                                                        // 0x0428 (size: 0x4)
    int32 MaxFractionalDigits;                                                        // 0x042C (size: 0x4)
    bool bAlwaysUsesDeltaSnap;                                                        // 0x0430 (size: 0x1)
    char padding_1[0x3];                                                              // 0x0431 (size: 0x3)
    float Delta;                                                                      // 0x0434 (size: 0x4)
    float SliderExponent;                                                             // 0x0438 (size: 0x4)
    char padding_2[0x4];                                                              // 0x043C (size: 0x4)
    FSlateFontInfo Font;                                                              // 0x0440 (size: 0x88)
    TEnumAsByte<ETextJustify::Type> Justification;                                    // 0x04C8 (size: 0x1)
    char padding_3[0x3];                                                              // 0x04C9 (size: 0x3)
    float MinDesiredWidth;                                                            // 0x04CC (size: 0x4)
    bool ClearKeyboardFocusOnCommit;                                                  // 0x04D0 (size: 0x1)
    bool SelectAllTextOnCommit;                                                       // 0x04D1 (size: 0x1)
    char padding_4[0x6];                                                              // 0x04D2 (size: 0x6)
    FSlateColor ForegroundColor;                                                      // 0x04D8 (size: 0x28)
    FSpinBoxOnValueChanged OnValueChanged;                                            // 0x0500 (size: 0x10)
    void OnSpinBoxValueChangedEvent(float InValue);
    FSpinBoxOnValueCommitted OnValueCommitted;                                        // 0x0510 (size: 0x10)
    void OnSpinBoxValueCommittedEvent(float InValue, TEnumAsByte<ETextCommit::Type> CommitMethod);
    FSpinBoxOnBeginSliderMovement OnBeginSliderMovement;                              // 0x0520 (size: 0x10)
    void OnSpinBoxBeginSliderMovement();
    FSpinBoxOnEndSliderMovement OnEndSliderMovement;                                  // 0x0530 (size: 0x10)
    void OnSpinBoxValueChangedEvent(float InValue);
    uint8 bOverride_MinValue;                                                         // 0x0540 (size: 0x1)
    uint8 bOverride_MaxValue;                                                         // 0x0540 (size: 0x1)
    uint8 bOverride_MinSliderValue;                                                   // 0x0540 (size: 0x1)
    uint8 bOverride_MaxSliderValue;                                                   // 0x0540 (size: 0x1)
    char padding_5[0x3];                                                              // 0x0541 (size: 0x3)
    float MinValue;                                                                   // 0x0544 (size: 0x4)
    float MaxValue;                                                                   // 0x0548 (size: 0x4)
    float MinSliderValue;                                                             // 0x054C (size: 0x4)
    float MaxSliderValue;                                                             // 0x0550 (size: 0x4)
...
{
    FText Text;                                                                       // 0x0140 (size: 0x18)
    bool bEnableWidthFitting;                                                         // 0x0158 (size: 0x1)
    char padding_0[0x3];                                                              // 0x0159 (size: 0x3)
    FTextBlockTextDelegate TextDelegate;                                              // 0x015C (size: 0x10)
    FText GetText();
    char padding_1[0x4];                                                              // 0x016C (size: 0x4)
    FSlateColor ColorAndOpacity;                                                      // 0x0170 (size: 0x28)
    FTextBlockColorAndOpacityDelegate ColorAndOpacityDelegate;                        // 0x0198 (size: 0x10)
    FSlateColor GetSlateColor();
    FSlateFontInfo Font;                                                              // 0x01A8 (size: 0x88)
    FSlateBrush StrikeBrush;                                                          // 0x0230 (size: 0x88)
    FVector2D ShadowOffset;                                                           // 0x02B8 (size: 0x8)
    FLinearColor ShadowColorAndOpacity;                                               // 0x02C0 (size: 0x10)
    FTextBlockShadowColorAndOpacityDelegate ShadowColorAndOpacityDelegate;            // 0x02D0 (size: 0x10)
    FLinearColor GetLinearColor();
    float MinDesiredWidth;                                                            // 0x02E0 (size: 0x4)
    bool bWrapWithInvalidationPanel;                                                  // 0x02E4 (size: 0x1)
    bool bAutoWrapText;                                                               // 0x02E5 (size: 0x1)
    ETextTransformPolicy TextTransformPolicy;                                         // 0x02E6 (size: 0x1)
    bool bSimpleTextMode;                                                             // 0x02E7 (size: 0x1)
    ...
    void SetGlowColor(FLinearColor InGlowColor);
...
{
    FShapedTextOptions ShapedTextOptions;                                             // 0x0120 (size: 0x3)
    TEnumAsByte<ETextJustify::Type> Justification;                                    // 0x0123 (size: 0x1)
    ETextWrappingPolicy WrappingPolicy;                                               // 0x0124 (size: 0x1)
    uint8 AutoWrapText;                                                               // 0x0125 (size: 0x1)
    char padding_0[0x2];                                                              // 0x0126 (size: 0x2)
    float WrapTextAt;                                                                 // 0x0128 (size: 0x4)
    FMargin Margin;                                                                   // 0x012C (size: 0x10)
    float LineHeightPercentage;                                                       // 0x013C (size: 0x4)
...
{
    int32 NumberOfPieces;                                                             // 0x0120 (size: 0x4)
    bool bAnimateHorizontally;                                                        // 0x0124 (size: 0x1)
    bool bAnimateVertically;                                                          // 0x0125 (size: 0x1)
    bool bAnimateOpacity;                                                             // 0x0126 (size: 0x1)
    char padding_0[0x1];                                                              // 0x0127 (size: 0x1)
    class USlateBrushAsset* PieceImage;                                               // 0x0128 (size: 0x8)
    FSlateBrush Image;                                                                // 0x0130 (size: 0x88)
...
{
    float EntryHeight;                                                                // 0x0868 (size: 0x4)
    float EntryWidth;                                                                 // 0x086C (size: 0x4)
    EListItemAlignment TileAlignment;                                                 // 0x0870 (size: 0x1)
    bool bWrapHorizontalNavigation;                                                   // 0x0871 (size: 0x1)
...
{
    FTreeViewBP_OnGetItemChildren BP_OnGetItemChildren;                               // 0x0878 (size: 0x10)
    void OnGetItemChildrenDynamic(class UObject* item, TArray<class UObject*>& Children);
    FTreeViewBP_OnItemExpansionChanged BP_OnItemExpansionChanged;                     // 0x0888 (size: 0x10)
...
{
    FMargin SlotPadding;                                                              // 0x0138 (size: 0x10)
    float MinDesiredSlotWidth;                                                        // 0x0148 (size: 0x4)
    float MinDesiredSlotHeight;                                                       // 0x014C (size: 0x4)
...
{
    FLinearColor ColorAndOpacity;                                                     // 0x0128 (size: 0x10)
    FUserWidgetColorAndOpacityDelegate ColorAndOpacityDelegate;                       // 0x0138 (size: 0x10)
    FLinearColor GetLinearColor();
    FSlateColor ForegroundColor;                                                      // 0x0148 (size: 0x28)
    FUserWidgetForegroundColorDelegate ForegroundColorDelegate;                       // 0x0170 (size: 0x10)
    FSlateColor GetSlateColor();
    FUserWidgetOnVisibilityChanged OnVisibilityChanged;                               // 0x0180 (size: 0x10)
    void OnVisibilityChangedEvent(ESlateVisibility InVisibility);
    char padding_0[0x18];                                                             // 0x0190 (size: 0x18)
    FMargin Padding;                                                                  // 0x01A8 (size: 0x10)
    TArray<class UUMGSequencePlayer*> ActiveSequencePlayers;                          // 0x01B8 (size: 0x10)
    class UUMGSequenceTickManager* AnimationTickManager;                              // 0x01C8 (size: 0x8)
    TArray<class UUMGSequencePlayer*> StoppedSequencePlayers;                         // 0x01D0 (size: 0x10)
    TArray<FNamedSlotBinding> NamedSlotBindings;                                      // 0x01E0 (size: 0x10)
    class UWidgetTree* WidgetTree;                                                    // 0x01F0 (size: 0x8)
    int32 Priority;                                                                   // 0x01F8 (size: 0x4)
    uint8 bSupportsKeyboardFocus;                                                     // 0x01FC (size: 0x1)
    uint8 bIsFocusable;                                                               // 0x01FC (size: 0x1)
    bool bIsDisableCursorNavi;                                                        // 0x01FD (size: 0x1)
    uint8 bStopAction;                                                                // 0x01FE (size: 0x1)
    uint8 bHasScriptImplementedTick;                                                  // 0x01FE (size: 0x1)
    uint8 bHasScriptImplementedPaint;                                                 // 0x01FE (size: 0x1)
    char padding_1[0x9];                                                              // 0x01FF (size: 0x9)
    EWidgetTickFrequency TickFrequency;                                               // 0x0208 (size: 0x1)
    char padding_2[0x7];                                                              // 0x0209 (size: 0x7)
    class UInputComponent* InputComponent;                                            // 0x0210 (size: 0x8)
    TArray<FAnimationEventBinding> AnimationCallbacks;                                // 0x0218 (size: 0x10)
...
{
    FLinearColor BackgroundColor;                                                     // 0x0138 (size: 0x10)
...
class UWidget : public UVisual
{
    ...
    FLinearColor DisabledColor;                                                       // 0x00B8 (size: 0x10)
    uint8 bOverride_Cursor;                                                           // 0x00C8 (size: 0x1)
    char padding_1[0x7];                                                              // 0x00C9 (size: 0x7)
    class USlateAccessibleWidgetData* AccessibleWidgetData;                           // 0x00D0 (size: 0x8)
    uint8 bIsVolatile;                                                                // 0x00D8 (size: 0x1)
    TEnumAsByte<EMouseCursor::Type> Cursor;                                           // 0x00D9 (size: 0x1)
    EWidgetClipping Clipping;                                                         // 0x00DA (size: 0x1)
    ESlateVisibility Visibility;                                                      // 0x00DB (size: 0x1)
    float RenderOpacity;                                                              // 0x00DC (size: 0x4)
    class UWidgetNavigation* Navigation;                                              // 0x00E0 (size: 0x8)
    EFlowDirectionPreference FlowDirectionPreference;                                 // 0x00E8 (size: 0x1)
    char padding_2[0x27];                                                             // 0x00E9 (size: 0x27)
    TArray<class UPropertyBinding*> NativeBindings;                                   // 0x0110 (size: 0x10)
...
{
    EWidgetSpace Space;                                                               // 0x0490 (size: 0x1)
    EWidgetTimingPolicy TimingPolicy;                                                 // 0x0491 (size: 0x1)
    char padding_0[0x6];                                                              // 0x0492 (size: 0x6)
    TSubclassOf<class UUserWidget> WidgetClass;                                       // 0x0498 (size: 0x8)
    FIntPoint DrawSize;                                                               // 0x04A0 (size: 0x8)
    bool bManuallyRedraw;                                                             // 0x04A8 (size: 0x1)
    bool bRedrawRequested;                                                            // 0x04A9 (size: 0x1)
    char padding_1[0x2];                                                              // 0x04AA (size: 0x2)
    float RedrawTime;                                                                 // 0x04AC (size: 0x4)
    char padding_2[0x8];                                                              // 0x04B0 (size: 0x8)
    FIntPoint CurrentDrawSize;                                                        // 0x04B8 (size: 0x8)
    bool bDrawAtDesiredSize;                                                          // 0x04C0 (size: 0x1)
    char padding_3[0x3];                                                              // 0x04C1 (size: 0x3)
    FVector2D Pivot;                                                                  // 0x04C4 (size: 0x8)
    bool bReceiveHardwareInput;                                                       // 0x04CC (size: 0x1)
    bool bWindowFocusable;                                                            // 0x04CD (size: 0x1)
    EWindowVisibility WindowVisibility;                                               // 0x04CE (size: 0x1)
    bool bApplyGammaCorrection;                                                       // 0x04CF (size: 0x1)
    class ULocalPlayer* OwnerPlayer;                                                  // 0x04D0 (size: 0x8)
    FLinearColor BackgroundColor;                                                     // 0x04D8 (size: 0x10)
    FLinearColor TintColorAndOpacity;                                                 // 0x04E8 (size: 0x10)
    float OpacityFromTexture;                                                         // 0x04F8 (size: 0x4)
    EWidgetBlendMode BlendMode;                                                       // 0x04FC (size: 0x1)
    bool bIsTwoSided;                                                                 // 0x04FD (size: 0x1)
    bool TickWhenOffscreen;                                                           // 0x04FE (size: 0x1)
    char padding_4[0x1];                                                              // 0x04FF (size: 0x1)
    class UBodySetup* BodySetup;                                                      // 0x0500 (size: 0x8)
    class UMaterialInterface* TranslucentMaterial;                                    // 0x0508 (size: 0x8)
    class UMaterialInterface* TranslucentMaterial_OneSided;                           // 0x0510 (size: 0x8)
    class UMaterialInterface* OpaqueMaterial;                                         // 0x0518 (size: 0x8)
    class UMaterialInterface* OpaqueMaterial_OneSided;                                // 0x0520 (size: 0x8)
    class UMaterialInterface* MaskedMaterial;                                         // 0x0528 (size: 0x8)
    class UMaterialInterface* MaskedMaterial_OneSided;                                // 0x0530 (size: 0x8)
    class UTextureRenderTarget2D* RenderTarget;                                       // 0x0538 (size: 0x8)
    class UMaterialInstanceDynamic* MaterialInstance;                                 // 0x0540 (size: 0x8)
    bool bAddedToScreen;                                                              // 0x0548 (size: 0x1)
    bool bEditTimeUsable;                                                             // 0x0549 (size: 0x1)
    char padding_5[0x2];                                                              // 0x054A (size: 0x2)
    FName SharedLayerName;                                                            // 0x054C (size: 0x8)
    int32 LayerZOrder;                                                                // 0x0554 (size: 0x4)
    EWidgetGeometryMode GeometryMode;                                                 // 0x0558 (size: 0x1)
    char padding_6[0x3];                                                              // 0x0559 (size: 0x3)
    float CylinderArcAngle;                                                           // 0x055C (size: 0x4)
    ETickMode TickMode;                                                               // 0x0560 (size: 0x1)
    char padding_7[0x27];                                                             // 0x0561 (size: 0x27)
    class UUserWidget* Widget;                                                        // 0x0588 (size: 0x8)
...
class UWidgetInteractionComponent : public USceneComponent
{
    ...
    char padding_0[0x10];                                                             // 0x0218 (size: 0x10)
    ...
    char padding_2[0x1];                                                              // 0x023B (size: 0x1)
    ...
    char padding_3[0x7C];                                                             // 0x0254 (size: 0x7C)
    FHitResult CustomHitResult;                                                       // 0x02D0 (size: 0x88)
    ...
    FHitResult LastHitResult;                                                         // 0x0370 (size: 0x88)
    bool bIsHoveredWidgetInteractable;                                                // 0x03F8 (size: 0x1)
    bool bIsHoveredWidgetFocusable;                                                   // 0x03F9 (size: 0x1)
    bool bIsHoveredWidgetHitTestVisible;                                              // 0x03FA (size: 0x1)
...
{
    int32 ActiveWidgetIndex;                                                          // 0x0138 (size: 0x4)
...
{
    bool bWindowButtonsEnabled;                                                       // 0x0138 (size: 0x1)
    bool bDoubleClickTogglesFullscreen;                                               // 0x0139 (size: 0x1)
...
{
    FVector2D InnerSlotPadding;                                                       // 0x0138 (size: 0x8)
    float WrapWidth;                                                                  // 0x0140 (size: 0x4)
    float WrapSize;                                                                   // 0x0144 (size: 0x4)
    bool bExplicitWrapWidth;                                                          // 0x0148 (size: 0x1)
    bool bExplicitWrapSize;                                                           // 0x0149 (size: 0x1)
    TEnumAsByte<EOrientation> Orientation;                                            // 0x014A (size: 0x1)
