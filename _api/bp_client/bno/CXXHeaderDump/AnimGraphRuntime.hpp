...
struct FAnimNode_BlendListBase : public FAnimNode_Base
{
    ...
    int32 LODThreshold;                                                               // 0x0034 (size: 0x4)
    bool bResetChildOnActivation;                                                     // 0x0038 (size: 0x1)
    char padding_1[0x7];                                                              // 0x0039 (size: 0x7)
    class UCurveFloat* CustomBlendCurve;                                              // 0x0040 (size: 0x8)
    class UBlendProfile* BlendProfile;                                                // 0x0048 (size: 0x8)

}; // Size: 0xA0

struct FAnimNode_BlendListByBool : public FAnimNode_BlendListBase
{
    bool bActiveValue;                                                                // 0x00A0 (size: 0x1)

}; // Size: 0xA8

struct FAnimNode_BlendListByEnum : public FAnimNode_BlendListBase
{
    TArray<int32> EnumToPoseIndex;                                                    // 0x00A0 (size: 0x10)
    uint8 ActiveEnumValue;                                                            // 0x00B0 (size: 0x1)

}; // Size: 0xB8

struct FAnimNode_BlendListByInt : public FAnimNode_BlendListBase
{
    int32 ActiveChildIndex;                                                           // 0x00A0 (size: 0x4)
...
struct FAnimNode_BlendSpacePlayer : public FAnimNode_AssetPlayerBase
{
    ...
    char padding_1[0x88];                                                             // 0x0058 (size: 0x88)
...
struct FAnimNode_PoseBlendNode : public FAnimNode_PoseHandler
{
    ...
    uint8 bOverrideBasePose;                                                          // 0x00A0 (size: 0x1)
    uint8 bAdditiveOutput;                                                            // 0x00A0 (size: 0x1)
...
struct FAnimNode_PoseDriver : public FAnimNode_PoseHandler
{
    ...
    char padding_0[0x30];                                                             // 0x00C0 (size: 0x30)
    ...
    char padding_1[0x1];                                                              // 0x012F (size: 0x1)
...
struct FAnimNode_RigidBody : public FAnimNode_SkeletalControlBase
{
    ...
    FVector ExternalAcceleration;                                                     // 0x0180 (size: 0xC)
    FVector ExternalAngularAcceleration;                                              // 0x018C (size: 0xC)
    TArray<FVector> ExternalAccelerationArray;                                        // 0x0198 (size: 0x10)
    TArray<FVector> ExternalAngularAccelerationArray;                                 // 0x01A8 (size: 0x10)
    FVector ComponentLinearAccScale;                                                  // 0x01B8 (size: 0xC)
    FVector ComponentLinearVelScale;                                                  // 0x01C4 (size: 0xC)
    FVector ComponentAppliedLinearAccClamp;                                           // 0x01D0 (size: 0xC)
    FSimSpaceSettings SimSpaceSettings;                                               // 0x01DC (size: 0x40)
    float CachedBoundsScale;                                                          // 0x021C (size: 0x4)
    FBoneReference BaseBoneRef;                                                       // 0x0220 (size: 0x10)
    TEnumAsByte<ECollisionChannel> OverlapChannel;                                    // 0x0230 (size: 0x1)
    ESimulationSpace SimulationSpace;                                                 // 0x0231 (size: 0x1)
    bool bForceDisableCollisionBetweenConstraintBodies;                               // 0x0232 (size: 0x1)
    char padding_1[0x1];                                                              // 0x0233 (size: 0x1)
    uint8 bEnableWorldGeometry;                                                       // 0x0234 (size: 0x1)
    uint8 bOverrideWorldGravity;                                                      // 0x0234 (size: 0x1)
    uint8 bTransferBoneVelocities;                                                    // 0x0234 (size: 0x1)
    uint8 bFreezeIncomingPoseOnStart;                                                 // 0x0234 (size: 0x1)
    uint8 bClampLinearTranslationLimitToRefPose;                                      // 0x0234 (size: 0x1)
    char padding_2[0x3];                                                              // 0x0235 (size: 0x3)
    float WorldSpaceMinimumScale;                                                     // 0x0238 (size: 0x4)
    float EvaluationResetTime;                                                        // 0x023C (size: 0x4)
    float DeltaScale;                                                                 // 0x0240 (size: 0x4)
    int32 MaxIteration;                                                               // 0x0244 (size: 0x4)
    bool bDoIterationCheck;                                                           // 0x0248 (size: 0x1)
    char padding_3[0x3];                                                              // 0x0249 (size: 0x3)
    float MeshScale;                                                                  // 0x024C (size: 0x4)
...
struct FAnimNode_RotationOffsetBlendSpace : public FAnimNode_BlendSpacePlayer
{
    ...
    char padding_0[0x4];                                                              // 0x0188 (size: 0x4)
...
{
    char padding_0[0xA10];                                                            // 0x0000 (size: 0x0)
}; // Size: 0xA10
